...
(function() {
    ...
    function V(k, l, v, s, t) {
        ...
        t = t || !1;
        s.push([k, l, v, t]);
        return k.addEventListener ? (k.addEventListener(l, v, t),
        v) : k.attachEvent ? (s = function(l) {
            l = l || window.event;
    ...
    function fb(k) {
        if (k._menuButton)
            k.exportEnabled ? La(k._menuButton) : ua(k._menuButton);
        ...
        if (!k._dropdownMenu && k.exportEnabled && t) {
            ...
            V(v, "mouseout", function() {
                l || (this.style.backgroundColor = k.toolbar.backgroundColor,
    ...
    function gb(k) {
        if (!hb) {
            ...
            k.creditText = Y("B`ow`rKR/bnl")) : (l = k.updateOption("creditText"),
            ...
            if (k.creditHref && k.creditText) {
                ...
                k._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" + (k.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
    ...
    function va(k, l, v) {
        l.getAttribute("state") || (l.style.backgroundColor = k.toolbar.backgroundColor,
        ...
        l.getAttribute("state") !== v && (l.setAttribute("state", v),
        ...
        l.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + ib[v].image + "' alt='" + k._cultureInfo[v + "Text"] + "' />")
    }
    function La() {
    ...
    function Ra(k, l, v, s, t) {
        ...
        "undefined" !== typeof s && (k = Math.min(s, k),
        "undefined" !== typeof t && (k = Math.max(t, k)));
    ...
    function W(k, l, v, t, w) {
        ...
        k = {};
        this.theme && s(this.parent) && s(l) && s(t) ? k = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[l]) && (null === t ? k = this.parent.themeOptions[l] : 0 < this.parent.themeOptions[l].length && (t = Math.min(this.parent.themeOptions[l].length - 1, t),
    ...
    var Ga = !1, I = {}, t = !!document.createElement("canvas").getContext, qa = {
        ...
        en: {}
    }, w = t ? "Trebuchet MS, Helvetica, sans-serif" : "Arial", Ea = t ? "Impact, Charcoal, sans-serif" : "Arial", za = {
    ...
    var Xa = {}
      ...
      , fa = function(k, l, v) {
        ...
        for (var N = 0; E && N < E.length; N++)
            ...
            "." === l && 0 > P)
                ...
                if ("%" === l)
                    ...
                    "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || (S = !0);
                0 > P ? (M.push(l),
                "#" === l || "0" === l ? R++ : "," === l && V++) : (G.push(l),
                "#" !== l && "0" !== l || I++)
            }
        S && (l = Math.floor(k),
        E = -Math.floor(Math.log(k) / Math.LN10 + 1),
        W = 0 === k ? 0 : 0 === l ? -(R + E) : String(l).length - R,
        D /= Math.pow(10, W));
        0 > P && (P = N);
        D = (k * D).toFixed(I);
        l = D.split(".");
            ...
            "#" === l || "0" === l)
                ...
                P === R) {
                    var X = D
                      , D = [];
                    if ("0" === l)
                        for (l = R - I - (X ? X.length : 0); 0 < l; )
                            X.unshift("0"),
                            l--;
                    for (; 0 < X.length; )
                        v = X.pop() + v,
                        S++,
                        0 === S % E && (N === V && 0 < X.length) && (v = w + v)
                } else
                    0 < D.length ? (v = D.pop() + v,
                    I++,
                    S++) : "0" === l && (v = "0" + v,
                    I++,
                    S++),
                    0 === S % E && (N === V && 0 < D.length) && (v = w + v);
            else
                "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (N++,
                E = S,
                S = 0,
                0 < D.length && (v = w + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
        ...
        for (M = !1; 0 < G.length; )
            l = G.shift(),
            "#" === l || "0" === l ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(),
            M = !0) : "0" === l && (w += "0",
            M = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""),
      ...
      , Oa = function(k) {
        var l = 0
          , v = 0;
        k = k || window.event;
        k.offsetX || 0 === k.offsetX ? (l = k.offsetX,
        v = k.offsetY) : k.layerX || 0 == k.layerX ? (l = k.layerX,
        v = k.layerY) : (l = k.pageX - k.target.offsetLeft,
      ...
      , da = function(k, l, v, s, t, w, D, E, P, M, S, R, G) {
        ...
        k.strokeStyle = E,
        k.moveTo(l, v),
        k.rect(l - G, v - G, s - l + 2 * G, t - v + 2 * G),
        k.stroke());
        k.restore();
        !0 === P && (k.save(),
        k.beginPath(),
        ...
        k.lineTo(s, v),
        k.closePath(),
        D = k.createLinearGradient((s + l) / 2, v + I, (s + l) / 2, v),
        D.addColorStop(0, w),
        ...
        k.lineTo(s, t),
        k.closePath(),
        D = k.createLinearGradient((s + l) / 2, t - I, (s + l) / 2, t),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, .4)"),
        k.fillStyle = D,
        k.fill(),
        ...
        k.lineTo(l, t),
        k.closePath(),
        D = k.createLinearGradient(l + I, (t + v) / 2, l, (t + v) / 2),
        D.addColorStop(0, w),
        ...
        k.lineTo(s - I, t - I),
        k.lineTo(s, t),
        D = k.createLinearGradient(s - I, (t + v) / 2, s, (t + v) / 2),
        D.addColorStop(0, w),
        D.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        k.fillStyle = D,
        D.addColorStop(0, w),
    ...
    W.prototype.setOptions = function(k, l) {
        if (qa[this._defaultsKey]) {
            ...
            Ga && window.console && console.log("defaults not set")
    }
    ;
    W.prototype.get = function(k) {
        ...
        if (l.hasOwnProperty(k) || l.publicProperties && l.publicProperties.hasOwnProperty(k))
            return this[k];
    ...
    W.prototype.set = function(k, l, s) {
        ...
        else if (t.hasOwnProperty(k) || t.publicProperties && t.publicProperties.hasOwnProperty(k) && "readWrite" === t.publicProperties[k])
    ...
    W.prototype.addTo = function(k, l, s, t) {
        ...
        k.splice(s, 0, l),
        t && (this.stockChart || this.chart || this).render()) : window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(k) && "readOnly" === w.publicProperties[k] ? window.console.log('Property "' + k + '" is read-only.') : window.console.log('Property "' + k + "\" doesn't exist. Please check for typo."))
    }
    ;
        ...
        if ("undefined" !== typeof k || this.options._isPlaceholder)
            ...
            this.isOptionsInArray) {
                ...
                var l = this.parent.options[this.optionsName]
                  , s = l.length;
                this.options._isPlaceholder || (Ca(l),
    ...
    W.prototype.updateOption = function(k) {
        ...
        var l = qa[this._defaultsKey]
          ...
          , I = this._index;
        this.theme && s(this.parent) && s(E) && s(I) ? t = s(this.predefinedThemes[this.theme]) ? this.predefinedThemes.light1 : this.predefinedThemes[this.theme] : this.parent && (this.parent.themeOptions && this.parent.themeOptions[E]) && (null === I ? t = this.parent.themeOptions[E] : 0 < this.parent.themeOptions[E].length && (t = Math.min(this.parent.themeOptions[E].length - 1, I),
        t = this.parent.themeOptions[E][t]));
        this.themeOptions = t;
    ...
    W.prototype.addEventListener = function(k, l, s) {
        k && l && (this._eventListeners[k] = this._eventListeners[k] || [],
    ...
    la.prototype._initialize = function() {
        s(this.padding) || "object" !== typeof this.padding ? this.topPadding = this.rightPadding = this.bottomPadding = this.leftPadding = Number(this.padding) | 0 : (this.topPadding = s(this.padding.top) ? 0 : Number(this.padding.top) | 0,
    ...
    la.prototype.render = function(k) {
        if (0 !== this.fontSize) {
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++)
                ...
                "right" === this.horizontalAlign ? t = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding : "left" === this.horizontalAlign ? t = this.leftPadding : "center" === this.horizontalAlign && (t = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding),
                this.ctx.fillText(E.text, t, w),
                w += E.height;
            this.ctx.font = l;
            k && this.ctx.restore()
        }
    ...
    la.prototype._getLineWithWidth = function(k, l, s) {
        ...
        s > l && 1 < D.length && (D = D.substr(0, D.length - 1),
        s = this.ctx.measureText(D).width);
        l = !0;
        if (D.length === k.length || " " === k[D.length])
            l = !1;
        l && (k = D.split(" "),
        1 < k.length && k.pop(),
        D = k.join(" "),
    ...
    ya.prototype.setLayout = function() {
        if (this.text) {
            var k = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, l = k.layoutManager.getFreeSpace(), t = l.x1, w = l.y1, E = 0, I = 0, D = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, P, G;
            ...
            I = 0.5 * l.height - this.margin - 2,
            E = 0) : "center" === this.verticalAlign && ("left" === this.horizontalAlign || "right" === this.horizontalAlign ? (null === this.maxWidth && (this.maxWidth = l.height - 4),
            I = 0.5 * l.width - this.margin - 2) : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = l.width - 4),
            I = 0.5 * l.height - 4));
            var M;
            s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0,
            M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0,
            M *= 1.25) : M = 2.5 * this.padding;
            ...
            M = I.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign ? ("top" === this.verticalAlign ? (w = l.y1 + 2,
            G = "top") : "bottom" === this.verticalAlign && (w = l.y2 - 2 - M.height,
            G = "bottom"),
            "left" === this.horizontalAlign ? t = l.x1 + 2 : "center" === this.horizontalAlign ? t = l.x1 + l.width / 2 - M.width / 2 : "right" === this.horizontalAlign && (t = l.x2 - 2 - M.width - D),
            P = this.horizontalAlign,
            this.width = M.width,
            this.height = M.height) : "center" === this.verticalAlign && ("left" === this.horizontalAlign ? (t = l.x1 + 2,
            w = l.y2 - 2 - (this.maxWidth / 2 - M.width / 2),
            E = -90,
            G = "left",
            this.width = M.height,
            this.height = M.width) : "right" === this.horizontalAlign ? (t = l.x2 - 2,
            w = l.y1 + 2 + (this.maxWidth / 2 - M.width / 2),
            E = 90,
            G = "right",
            this.width = M.height,
            this.height = M.width) : "center" === this.horizontalAlign && (w = k.y1 + (k.height / 2 - M.height / 2),
    ...
    var Ka = {
        ...
        formatNumber: function(k, l, s) {
            s = s || "en";
            if (Ja[s])
                return fa(k, l || "#,##0.##", new Ia(s));
            throw "Unknown Culture Name";
        },
        formatDate: function(k, l, s) {
            s = s || "en";
            if (Ja[s])
                return Aa(k, l || "DD MMM YYYY", new Ia(s));
            throw "Unknown Culture Name";
        }
    };
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Ka : "function" === typeof define && define.amd ? define([], function() {
        return Ka
    }) : window.CanvasJS = Ka;
    Ka.Chart = function() {
        function k(a, d) {
        ...
        function l(a, d, c) {
            d = d || {};
            s(c) ? (this.predefinedThemes = ab,
            this.optionsName = this.parent = this.index = null) : (this.parent = c.parent,
            this.index = c.index,
            ...
            t ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ta(a, d),
        ...
        function w(a, d, c, b, e, f, n, m, A, g) {
            ...
            a.beginPath();
            A && 0 < m.thickness ? (a.moveTo(b - n.thickness / 2, Math.round((c + e) / 2) - q),
            a.lineTo(d + n.thickness / 2, Math.round((c + e) / 2) - q)) : 0 < m.thickness && (a.moveTo(Math.round((d + b) / 2) - q, c + n.thickness / 2),
            ...
            a.beginPath();
            A && 0 < n.thickness ? (a.moveTo(b - r, c),
            a.lineTo(b - r, e),
            a.moveTo(d + r, c),
            a.lineTo(d + r, e)) : 0 < n.thickness && (a.moveTo(d, c + r),
            a.lineTo(b, c + r),
            a.moveTo(d, e - r),
            a.lineTo(b, e - r));
            a.stroke();
        ...
        function D(a, d, c, b, e, f) {
            ...
            this.isOptionsInArray = !0;
            "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX",
            ...
            this.options.interval || (this.intervalType = null)) : "left" === f || "bottom" === f ? (this.optionsName = "axisY",
        ...
        l.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    V(this._zoomButton, "click", function() {
                        ...
                        a.panEnabled = !0,
                        va(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0,
                        a.panEnabled = !1,
                ...
                V(this._resetButton, "mouseover", function() {
            ...
            fb(this);
            "none" !== this._toolBar.style.display && this._zoomButton && (this.panEnabled ? va(a, a._zoomButton, "zoom") : va(a, a._zoomButton, "pan"),
            a._resetButton.getAttribute("state") !== a._cultureInfo.resetText && va(a, a._resetButton, "reset"));
        ...
        l.prototype._initialize = function() {
            ...
            if (this.options.data) {
                for (var c = 0; c < this.options.data.length; c++)
                    if (a++,
                    !this.options.data[c].type || 0 <= l._supportedChartTypes.indexOf(this.options.data[c].type)) {
        ...
        l.prototype.setLayout = function() {
                ...
                if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            ...
                            this.axisY.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[0] = new D(this,"axisY",this.options.axisY,0,"axisY","left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[0] = new D(this,"axisY",this.options.axisY,0,"axisY","bottom"))),
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            ...
                            this.axisY2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[0] = new D(this,"axisY2",this.options.axisY2,0,"axisY","right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[0] = new D(this,"axisY2",this.options.axisY2,0,"axisY","top"))),
                    ...
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            ...
                            this.axisX.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[0] = new D(this,"axisX",this.options.axisX,0,"axisX","bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[0] = new D(this,"axisX",this.options.axisX,0,"axisX","left"))),
                    ...
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            ...
                            this.axisX2.length || ("normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[0] = new D(this,"axisX2",this.options.axisX2,0,"axisX","top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[0] = new D(this,"axisX2",this.options.axisX2,0,"axisX","right"))),
            ...
            c ? (La(this._zoomButton, this._resetButton),
            this._toolBar.style.border = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor,
            this._zoomButton.style.borderRight = this.toolbar.borderThickness + "px solid " + this.toolbar.borderColor,
            this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor) : (ua(this._zoomButton, this._resetButton),
            ...
            for (d = 0; d < this._axes.length; d++)
                if (this._axes[d].scaleBreaks && this._axes[d].scaleBreaks._appliedBreaks.length) {
                    t ? (this._breaksCanvas = ta(this.width, this.height, !0),
        ...
        l.prototype.renderElements = function() {
            ...
            t && this._breaksCanvas && (this._preRenderCtx.drawImage(this.canvas, 0, 0, this.width, this.height),
            ...
            for (d = 0; d < this.plotInfo.plotTypes.length; d++)
                for (var f = this.plotInfo.plotTypes[d], n = 0; n < f.plotUnits.length; n++) {
                    var m = f.plotUnits[n]
                      , A = null;
                    m.targetCanvas = null;
                    this.animatedRender && (m.targetCanvas = ta(this.width, this.height),
                    ...
                    for (var g = 0; g < m.dataSeriesIndexes.length; g++)
                        this._dataInRenderedOrder.push(this.data[m.dataSeriesIndexes[g]]);
                    this.animatedRender && (m.targetCanvasCtx.miterLimit = e,
                    A && c.push(A))
                }
            ...
            if (0 < c.length)
                r.disableToolTip = !0,
                r._animator.animate(200, r.animationDuration, function(a) {
                    ...
                    for (var e = 0; e < c.length; e++)
                        A = c[e],
                        1 > a && "undefined" !== typeof A.startTimePercent ? a >= A.startTimePercent && A.animationCallback(A.easingFunction(a - A.startTimePercent, 0, 1, 1 - A.startTimePercent), A) : A.animationCallback(A.easingFunction(a, 0, 1, 1), A);
                ...
                if (r._breaksCanvas)
                    if (t)
                        ...
                        for (g = 0; g < r._axes.length; g++)
                            r._axes[g].createMask();
            ...
            for (g = 0; g < this._axes.length; g++)
                this._axes[g].maskCanvas && (delete this._axes[g].maskCanvas,
                delete this._axes[g].maskCtx)
        }
        ;
        ...
        l.prototype.categoriseDataSeries = function() {
            for (var a = "", d = 0; d < this.data.length; d++)
                if (a = this.data[d],
                a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= l._supportedChartTypes.indexOf(a.type)) {
        ...
        l.prototype._processMultiseriesPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var m = this.data[a.dataSeriesIndexes[n]], A = 0, g = !1, r = !1, q;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement)
                        var p = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity
                    ...
                    if (m.dataPoints[A].x && m.dataPoints[A].x.getTime || "dateTime" === m.xValueType)
                        f = !0;
                    for (A = 0; A < m.dataPoints.length; A++) {
                        "undefined" === typeof m.dataPoints[A].x && (m.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0));
                        m.dataPoints[A].x.getTime ? (f = !0,
                        b = m.dataPoints[A].x.getTime()) : b = m.dataPoints[A].x;
                        e = m.dataPoints[A].y;
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        ...
                        if (0 < A) {
                            ...
                            null !== e && null !== m.dataPoints[A - 1].y && (a.axisY.logarithmic ? (C = e / m.dataPoints[A - 1].y,
                            1 > C && (C = 1 / C),
                            d.minDiff > C && 1 !== C && (d.minDiff = C)) : (C = e - m.dataPoints[A - 1].y,
                            0 > C && (C *= -1),
                        ...
                        if (b < p && !g)
                            ...
                            null === e ? c.viewPortMin === b && q < b && (c.viewPortMin = q) : (e < d.viewPortMin && "number" === typeof e && (d.viewPortMin = e),
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = [], m = [], A = Infinity, g = -Infinity, r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if ("normal" === q.axisPlacement || "xySwapped" === q.axisPlacement)
                        var aa = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity
                    ...
                    if (q.dataPoints[p].x && q.dataPoints[p].x.getTime || "dateTime" === q.xValueType)
                        f = !0;
                    for (p = 0; p < q.dataPoints.length; p++) {
                        "undefined" === typeof q.dataPoints[p].x && (q.dataPoints[p].x = p + (a.axisX.logarithmic ? 1 : 0));
                        q.dataPoints[p].x.getTime ? (f = !0,
                        b = q.dataPoints[p].x.getTime()) : b = q.dataPoints[p].x;
                        ...
                        if (0 < p) {
                            ...
                            null !== e && null !== q.dataPoints[p - 1].y && (a.axisY.logarithmic ? 0 < e && (l = e / q.dataPoints[p - 1].y,
                            1 > l && (l = 1 / l),
                            d.minDiff > l && 1 !== l && (d.minDiff = l)) : (l = e - q.dataPoints[p - 1].y,
                            0 > l && (l *= -1),
                            d.minDiff > l && 0 !== l && (d.minDiff = l)))
                        }
                        if (b < aa && !h)
                            null !== q.dataPoints[p].y && (k = b);
                        else {
                            if (!h && (h = !0,
                            0 < p)) {
                                p -= 2;
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === q.dataPoints[p].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            0 <= e ? n[b] ? n[b] += e : (n[b] = e,
                            A = Math.min(e, A)) : m[b] ? m[b] += e : (m[b] = e,
                            g = Math.max(e, g)))
                        }
                    }
                    ...
                    d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, m)) : (d.dataPointYPositiveSums = n,
                    d.dataPointYNegativeSums = m));
                    q.axisX.valueType = q.xValueType = f ? "dateTime" : "number"
                }
                for (p in n)
                    n.hasOwnProperty(p) && !isNaN(p) && (a = n[p],
                    a < d.min && (d.min = Math.min(a, A)),
                    a > d.max && (d.max = a),
                    p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)),
                    a > d.viewPortMax && (d.viewPortMax = a)));
                for (p in m)
                    m.hasOwnProperty(p) && !isNaN(p) && (a = m[p],
                    a < d.min && (d.min = a),
                    a > d.max && (d.max = Math.max(a, g)),
                    p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a),
                    a > d.viewPortMax && (d.viewPortMax = Math.max(a, g))))
            }
        }
        ;
        l.prototype._processStacked100PlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = !1, m = !1, A = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    for (q = 0; q < r.dataPoints.length; q++) {
                        ...
                        r.dataPoints[q].x.getTime ? (f = !0,
                        b = r.dataPoints[q].x.getTime()) : b = r.dataPoints[q].x;
                        ...
                        if (0 < q) {
                            ...
                            s(e) || null === r.dataPoints[q - 1].y || (a.axisY.logarithmic ? 0 < e && (u = e / r.dataPoints[q - 1].y,
                            1 > u && (u = 1 / u),
                            d.minDiff > u && 1 !== u && (d.minDiff = u)) : (u = e - r.dataPoints[q - 1].y,
                            0 > u && (u *= -1),
                        ...
                        if (b < k && !p)
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && C < b && (c.viewPortMin = C) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e,
                            0 <= e ? n = !0 : 0 > e && (m = !0),
                ...
                a.axisY.logarithmic ? (d.max = s(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)),
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : n && !m ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : n && m ? (d.max = s(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99),
                d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)) : !n && m && (d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1),
        ...
        l.prototype._processMultiYPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, n, m = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    var g = this.data[a.dataSeriesIndexes[A]], r = 0, q = !1, p = !1, h, C, k;
                    if ("normal" === g.axisPlacement || "xySwapped" === g.axisPlacement)
                        var l = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : a.axisX.logarithmic ? 0 : -Infinity
                          , u = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    if (g.dataPoints[r].x && g.dataPoints[r].x.getTime || "dateTime" === g.xValueType)
                        m = !0;
                    for (r = 0; r < g.dataPoints.length; r++) {
                        "undefined" === typeof g.dataPoints[r].x && (g.dataPoints[r].x = r + (a.axisX.logarithmic ? 1 : 0));
                        g.dataPoints[r].x.getTime ? (m = !0,
                        b = g.dataPoints[r].x.getTime()) : b = g.dataPoints[r].x;
                        ...
                        f < d.min && (d.min = f);
                        n > d.max && (d.max = n);
                        0 < r && (a.axisX.logarithmic ? (C = b / g.dataPoints[r - 1].x,
                        1 > C && (C = 1 / C),
                        c.minDiff > C && 1 !== C && (c.minDiff = C)) : (C = b - g.dataPoints[r - 1].x,
                        0 > C && (C *= -1),
                        c.minDiff > C && 0 !== C && (c.minDiff = C)),
                        e && (null !== e[0] && g.dataPoints[r - 1].y && null !== g.dataPoints[r - 1].y[0]) && (a.axisY.logarithmic ? (C = e[0] / g.dataPoints[r - 1].y[0],
                        1 > C && (C = 1 / C),
                        d.minDiff > C && 1 !== C && (d.minDiff = C)) : (C = e[0] - g.dataPoints[r - 1].y[0],
                        0 > C && (C *= -1),
                        d.minDiff > C && 0 !== C && (d.minDiff = C))));
                        if (!(b < l) || q) {
                            if (!q && (q = !0,
                            ...
                            null === e ? c.viewPortMin === b && h < b && (c.viewPortMin = h) : (f < d.viewPortMin && (d.viewPortMin = f),
            ...
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (m.dataPoints[A].x && m.dataPoints[A].x.getTime || "dateTime" === m.xValueType)
                        f = !0;
                    for (A = 0; A < m.dataPoints.length; A++)
                        "undefined" !== typeof m.dataPoints[A].isCumulativeSum && !0 === m.dataPoints[A].isCumulativeSum ? (m.dataPointEOs[A].cumulativeSumYStartValue = 0,
                        m.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum,
                        m.dataPoints[A].y = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof m.dataPoints[A].isIntermediateSum && !0 === m.dataPoints[A].isIntermediateSum ? (m.dataPointEOs[A].cumulativeSumYStartValue = q,
                        m.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum,
                        m.dataPoints[A].y = 0 === A ? 0 : b,
                        q = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum,
                        b = 0) : (e = "number" !== typeof m.dataPoints[A].y ? 0 : m.dataPoints[A].y,
                        m.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : m.dataPointEOs[A - 1].cumulativeSum,
                        m.dataPointEOs[A].cumulativeSum = 0 === A ? e : m.dataPointEOs[A - 1].cumulativeSum + e,
                        b += e);
                    for (A = 0; A < m.dataPoints.length; A++)
                        if ("undefined" === typeof m.dataPoints[A].x && (m.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)),
                        m.dataPoints[A].x.getTime ? (f = !0,
                        b = m.dataPoints[A].x.getTime()) : b = m.dataPoints[A].x,
                        e = m.dataPoints[A].y,
                        b < c.min && (c.min = b),
                        b > c.max && (c.max = b),
                        m.dataPointEOs[A].cumulativeSum < d.min && (d.min = m.dataPointEOs[A].cumulativeSum),
                        m.dataPointEOs[A].cumulativeSum > d.max && (d.max = m.dataPointEOs[A].cumulativeSum),
                        0 < A && (a.axisX.logarithmic ? (q = b / m.dataPoints[A - 1].x,
                        1 > q && (q = 1 / q),
                        c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = b - m.dataPoints[A - 1].x,
                        0 > q && (q *= -1),
                        c.minDiff > q && 0 !== q && (c.minDiff = q)),
                        null !== e && null !== m.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = m.dataPointEOs[A].cumulativeSum / m.dataPointEOs[A - 1].cumulativeSum,
                        1 > e && (e = 1 / e),
                        d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = m.dataPointEOs[A].cumulativeSum - m.dataPointEOs[A - 1].cumulativeSum,
                        0 > e && (e *= -1),
                        ...
                        !(b < p) || g) {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < A && (m.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = m.dataPointEOs[A - 1].cumulativeSum),
                            m.dataPointEOs[A - 1].cumulativeSum > d.viewPortMax && (d.viewPortMax = m.dataPointEOs[A - 1].cumulativeSum));
        ...
        l.prototype.calculateAutoBreaks = function() {
            function a(a, b, c, e) {
                if (e)
                    return c = Math.pow(Math.min(c * a / b, b / a), 0.2),
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, g = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            var k = e.data[a.dataSeriesIndexes[A]];
                            if (!(4 > k.dataPoints.length))
                                for (q = 0; q < k.dataPoints.length; q++)
                                    if (b && (p = (n + 1 - g) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                    h = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() : k.dataPoints[q].x,
                                    p = Math.floor((h - g) / p),
                                    h < f[p].min && (f[p].min = h),
                                    h > f[p].max && (f[p].max = h)),
                                    c) {
                                        var l = (r + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                                        if ((h = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && h.length)
                                            for (var t = 0; t < h.length; t++)
                                                p = Math.floor((h[t] - m) / l),
                                                h[t] < d[p].min && (d[p].min = h[t]),
                                                h[t] > d[p].max && (d[p].max = h[t]);
                                        else
                                            s(h) || (p = Math.floor((h - m) / l),
                                            h < d[p].min && (d[p].min = h),
                                            h > d[p].max && (d[p].max = h))
                                    }
                        }
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, g = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
                        var m = e.data[a.dataSeriesIndexes[n]];
                        if (!(4 > m.dataPoints.length))
                            for (g = 0; g < m.dataPoints.length; g++)
                                h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100,
                                b = m.dataPoints[g].x.getTime ? m.dataPoints[g].x.getTime() : m.dataPoints[g].x,
                                h = Math.floor((b - c) / h),
                                b < f[h].min && (f[h].min = b),
                                b > f[h].max && (f[h].max = b)
                    }
                ...
                for (n = 0; n < this._axes.length; n++)
                    if (this._axes[n].dataInfo._dataRanges) {
                        ...
                        if (this._axes[n].dataInfo.dataPointYPositiveSums) {
                            ...
                            r = g;
                            for (m in p)
                                if (p.hasOwnProperty(m) && !isNaN(m) && (q = p[m],
                                !s(q))) {
                        ...
                        if (this._axes[n].dataInfo.dataPointYNegativeSums) {
                            ...
                            r = g;
                            for (m in p)
                                p.hasOwnProperty(m) && !isNaN(m) && (q = -1 * p[m],
                                s(q) || (h = Math.floor((q - A) / b),
                                q < r[h].min && (r[h].min = q),
                                q > r[h].max && (r[h].max = q)));
                        ...
                        if (this._axes[n].scaleBreaks.customBreaks)
                            for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].startValue && this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].end || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue && this._axes[n].scaleBreaks.customBreaks[m].endValue <= f[b].end)
                                        f.splice(b, 1),
                                        b--;
                        f.sort(function(a, b) {
                        ...
                        for (m = 0; m < Math.min(f.length, this._axes[n].scaleBreaks.maxNumberOfAutoBreaks); m++)
                            b = a(f[m].start, f[m].end, this._axes[n].logarithmic ? this._axes[n].dataInfo.max / this._axes[n].dataInfo.min : this._axes[n].dataInfo.max - this._axes[n].dataInfo.min, this._axes[n].logarithmic),
                            this._axes[n].scaleBreaks.autoBreaks.push(new U(this,"autoBreaks",b,m,++this._eventManager.lastObjectId,this._axes[n].scaleBreaks)),
                            this._axes[n].scaleBreaks._appliedBreaks.push(this._axes[n].scaleBreaks.autoBreaks[this._axes[n].scaleBreaks.autoBreaks.length - 1]);
        ...
        l.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            for (c = 0; c < b.length; c++)
                if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type)
                    if (e = ma("markerSize", b[c].dataPoint, b[c].dataSeries) || 8,
                    b[c].distance <= e / 2) {
                        d = !0;
                        break
                    }
        ...
        l.prototype.getObjectAtXY = function(a, d, c) {
            ...
            if (c = this.getDataPointAtXY(a, d, c || !1))
                ...
                b = Ya(a, d, this._eventManager.ghostCtx);
            else
            ...
            if (a.changedTouches && this.interactivityEnabled) {
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    try {
                        ...
                        if (1 < Math.abs(n) && this._lastTouchData.scroll || 5 < Math.abs(n) && 250 > f)
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled)
                        ...
                        for (c = 0; c < d.length; c++)
                            ...
                            n.initMouseEvent(e, !0, !0, window, 1, b.screenX, b.screenY, b.clientX, b.clientY, !1, !1, !1, !1, 0, null),
        ...
        l.prototype._mouseEventHandler = function(a) {
            ...
            l.capturedEventParam && (b = l.capturedEventParam,
            "mouseup" === c && (l.capturedEventParam = null,
            b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)),
            b.hasOwnProperty(c) && ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? a.target !== b.chart.overlaidCanvas && t || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
            if (this.interactivityEnabled)
                if (this._ignoreNextEvent)
                    this._ignoreNextEvent = !1;
                else if (a.preventManipulation && a.preventManipulation(),
                a.preventDefault && a.preventDefault(),
                Ga && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y),
                        ...
                        for (var f = 0; f < this._events.length; f++)
                            if (this._events[f].hasOwnProperty(c))
                                ...
                                d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2) {
                                    ...
                                    "mousedown" === c && !0 === b.capture ? (l.capturedEventParam = b,
                ...
                if (this.panEnabled || this.zoomEnabled) {
                    if (this.panEnabled)
                        for (e = f = 0; e < this._axes.length; e++)
                            c = this._axes[e],
                            c.logarithmic ? c.viewportMinimum < c.minimum ? (f = c.minimum / c.viewportMinimum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum * f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum * f,
                            n = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum / c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum / f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum / f,
                            n = !0) : c.viewportMinimum < c.minimum ? (f = c.minimum - c.viewportMinimum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum + f,
                            c.sessionVariables.newViewportMaximum = c.viewportMaximum + f,
                            n = !0) : c.viewportMaximum > c.maximum && (f = c.viewportMaximum - c.maximum,
                            c.sessionVariables.newViewportMinimum = c.viewportMinimum - f,
                    ...
                    n && (this._ignoreNextEvent = !0,
                    this._dispatchRangeEvent("rangeChanging", "zoom"),
                    this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type = "rangeChanging",
                    ...
                    this.stockChart && (this.stockChart.navigator && this.stockChart.navigator.enabled) && (this.stockChart._rangeEventParameter.type = "rangeChanged",
                    this.stockChart.dispatchEvent("rangeChanged", this.stockChart._rangeEventParameter, this.stockChart)),
                    n && (this.zoomEnabled && "none" === this._zoomButton.style.display) && (La(this._zoomButton, this._resetButton),
                    va(this, this._zoomButton, "pan"),
                    va(this, this._resetButton, "reset")))
                }
            }
        ...
        l.prototype._plotAreaMouseMove = function(a, d) {
            if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
                ...
                2 < Math.abs(c) && 8 > Math.abs(c) && (this.panEnabled || this.zoomEnabled) ? (this.toolTip.hide(),
                this.toolTip.dispatchEvent("hidden", {
                    chart: this,
                    toolTip: this.toolTip
                ...
                if ((!e || 2 < Math.abs(c) || !f || 2 < Math.abs(b)) && (this.panEnabled || this.zoomEnabled))
                    if (this.panEnabled)
                        ...
                        n._panTimerId = setTimeout(function(b, c, e, f) {
                            return function() {
                                n._zoomPanToSelectedRegion(b, c, e, f, !0) && (n._dispatchRangeEvent("rangeChanging", "pan"),
                                n.stockChart && (n.stockChart.navigator && n.stockChart.navigator.enabled) && (n.stockChart._rangeEventParameter.type = "rangeChanging",
                                n.stockChart.dispatchEvent("rangeChanging", n.stockChart._rangeEventParameter, n.stockChart)),
                                n.render(),
                                n._dispatchRangeEvent("rangeChanged", "pan"),
                                n.stockChart && (n.stockChart.navigator && n.stockChart.navigator.enabled) && (n.stockChart._rangeEventParameter.type = "rangeChanged",
                        ...
                        this.validateRegion(b, m, e ? a : this.plotArea.x2 - this.plotArea.x1, f ? d : this.plotArea.y2 - this.plotArea.y1, "xy" !== this.zoomType).isValid && (this.resetOverlayedCanvas(),
        ...
        l.prototype.validateRegion = function(a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), n = 0 <= this.zoomType.indexOf("y"), m = !1, A = [], g = [], r = [], q = 0; q < this._axes.length; q++)
                ("axisX" === this._axes[q].type && f || "axisY" === this._axes[q].type && n) && g.push(this._axes[q]);
            for (n = 0; n < g.length; n++) {
                ...
                if (q.scaleBreaks)
                    for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++)
                        f = q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= h;
                if (isFinite(q.dataInfo.minDiff))
                    if (C = q.getApparentDifference(p, h, null, !0),
                    !(f || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && C < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && C < 3 * Math.abs(q.dataInfo.minDiff)) || p < q.minimum || h > q.maximum))
                        A.push(q),
                        r.push({
                            val1: p,
                            val2: h
        ...
        l.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var g = this._indexLabels[a], r = g.chartType.toLowerCase(), q, p, m = ma("indexLabelFontColor", g.dataPoint, g.dataSeries), A = ma("indexLabelFontSize", g.dataPoint, g.dataSeries);
                ...
                var n = ma("indexLabelFontWeight", g.dataPoint, g.dataSeries)
                  ...
                  , l = s(g.dataPoint.indexLabelLineThickness) ? s(g.dataSeries.options.indexLabelLineThickness) ? 0 : g.dataSeries.options.indexLabelLineThickness : g.dataPoint.indexLabelLineThickness
                  ...
                  , x = null;
                if (0 <= g.dataSeries.type.indexOf("stacked") || "pie" === g.dataSeries.type || "doughnut" === g.dataSeries.type)
                    u = this.getPercentAndTotal(g.dataSeries, g.dataPoint);
                if (g.dataSeries.indexLabelFormatter || g.dataPoint.indexLabelFormatter)
                    x = {
                        chart: this,
                ...
                if (null !== z && "" !== z) {
                    var u = ma("indexLabelPlacement", g.dataPoint, g.dataSeries)
                      ...
                      , J = g.direction
                      , y = g.dataSeries.axisX
                      , B = g.dataSeries.axisY
                      , v = !1
                      , h = new la(d,{
                        x: 0,
                        y: 0,
                    ...
                    h.measureText();
                    g.dataSeries.indexLabelMaxWidth = h.maxWidth;
                    if ("stackedarea100" === r) {
                        if (g.point.x < c.x1 || g.point.x > c.x2 || g.point.y < c.y1 - 1 || g.point.y > c.y2 + 1)
                            continue
                    } else if ("rangearea" === r || "rangesplinearea" === r) {
                        if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum)
                            continue
                    } else if (0 <= r.indexOf("line") || 0 <= r.indexOf("area") || 0 <= r.indexOf("bubble") || 0 <= r.indexOf("scatter")) {
                        if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.dataPoint.y < B.viewportMinimum || g.dataPoint.y > B.viewportMaximum)
                            continue
                    } else if (0 <= r.indexOf("column") || "waterfall" === r || "error" === r && !g.axisSwapped) {
                        if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.bounds.y1 > c.y2 || g.bounds.y2 < c.y1)
                            continue
                    } else if (0 <= r.indexOf("bar") || "error" === r) {
                        if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.bounds.x1 > c.x2 || g.bounds.x2 < c.x1)
                            continue
                    } else if ("candlestick" === r || "ohlc" === r) {
                        if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum)
                            continue
                    } else if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum)
                        continue;
                    e = n = 2;
                    "horizontal" === x ? (m = h.width,
                    A = h.height) : (A = h.width,
                    m = h.height);
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== u ? (e = c.y1,
                        f = c.y2,
                        0 < J ? (p = g.point.y - A - n - b,
                        p < e && (p = "auto" === u ? Math.max(g.point.y, e) + n + b : e + n + b,
                        v = p + A > g.point.y)) : (p = g.point.y + n + b,
                        p > f - A - n - b && (p = "auto" === u ? Math.min(g.point.y, f) - A - n - b : f - A - n - b,
                        v = p < g.point.y))) : (e = Math.max(g.bounds.y1, c.y1),
                        f = Math.min(g.bounds.y2, c.y2),
                        b = 0 <= r.indexOf("range") || "error" === r ? 0 < J ? Math.max(g.bounds.y1, c.y1) + A / 2 + n : Math.min(g.bounds.y2, c.y2) - A / 2 - n : (Math.max(g.bounds.y1, c.y1) + Math.min(g.bounds.y2, c.y2)) / 2,
                        0 < J ? (p = Math.max(g.point.y, b) - A / 2,
                        p < e && ("bubble" === r || "scatter" === r) && (p = Math.max(g.point.y - A - n, c.y1 + n))) : (p = Math.min(g.point.y, b) - A / 2,
                        p > f - A - n && ("bubble" === r || "scatter" === r) && (p = Math.min(g.point.y + n, c.y2 - A - n))),
                        p = Math.min(p, f - A))
                    } else
                        0 <= r.indexOf("line") || 0 <= r.indexOf("area") || 0 <= r.indexOf("scatter") ? (u = "auto",
                        e = 4) : 0 <= r.indexOf("stacked") ? "auto" === u && (u = "inside") : "bubble" === r && (u = "inside"),
                        p = g.point.y - A / 2,
                        "inside" !== u ? (n = c.x1,
                        f = c.x2,
                        0 > J ? (q = g.point.x - m - e - b,
                        q < n && (q = "auto" === u ? Math.max(g.point.x, n) + e + b : n + e + b,
                        v = q + m > g.point.x)) : (q = g.point.x + e + b,
                        q > f - m - e - b && (q = "auto" === u ? Math.min(g.point.x, f) - m - e - b : f - m - e - b,
                        v = q < g.point.x))) : (n = Math.max(g.bounds.x1, c.x1),
                        Math.min(g.bounds.x2, c.x2),
                        b = 0 <= r.indexOf("range") || "error" === r ? 0 > J ? Math.max(g.bounds.x1, c.x1) + m / 2 + e : Math.min(g.bounds.x2, c.x2) - m / 2 - e : (Math.max(g.bounds.x1, c.x1) + Math.min(g.bounds.x2, c.x2)) / 2,
                        q = 0 > J ? Math.max(g.point.x, b) - m / 2 : Math.min(g.point.x, b) - m / 2,
                        q = Math.max(q, n));
                    "vertical" === x && (p += A);
                    h.x = q;
                    h.y = p;
                    h.render(!0);
                    l && ("inside" !== u && (0 > r.indexOf("bar") && ("error" !== r || !g.axisSwapped) && g.point.x > c.x1 && g.point.x < c.x2 || !v) && (0 > r.indexOf("column") && ("error" !== r || g.axisSwapped) && g.point.y > c.y1 && g.point.y < c.y2 || !v)) && (d.lineWidth = l,
                    d.strokeStyle = k ? k : "gray",
                    d.setLineDash && d.setLineDash(P(C, l)),
                    d.beginPath(),
                    d.moveTo(g.point.x, g.point.y),
                    0 <= r.indexOf("bar") || "error" === r && g.axisSwapped ? d.lineTo(q + (0 < g.direction ? 0 : m), p + ("horizontal" === x ? A : -A) / 2) : 0 <= r.indexOf("column") || "error" === r && !g.axisSwapped ? d.lineTo(q + m / 2, p + ((0 < g.direction ? A : -A) + ("horizontal" === x ? A : -A)) / 2) : d.lineTo(q + m / 2, p + ((p < g.point.y ? A : -A) + ("horizontal" === x ? A : -A)) / 2),
                    d.stroke())
                }
            }
            d = {
            ...
            for (a = 0; a < this._indexLabels.length; a++)
                g = this._indexLabels[a],
                h = ma("indexLabelBackgroundColor", g.dataPoint, g.dataSeries),
                g.dataSeries.indexLabelBackgroundColor = s(h) ? t ? "transparent" : null : h;
            return d
        }
        ;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    var r = g.dataPoints
                      , q = "solid";
                    if (c.setLineDash) {
                        var p = P(g.nullDataLineDashType, g.lineThickness)
                          , q = g.lineDashType
                          , h = P(q, g.lineThickness);
                        c.setLineDash(h)
                    }
                    var C = g.id;
                    ...
                    c.beginPath();
                    if (0 < r.length) {
                        for (var J = !1, u = 0; u < r.length; u++)
                            if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J)))
                                if ("number" !== typeof r[u].y)
                                    0 < u && !(g.connectNullData || J || l) && (c.stroke(),
                                    t && b.stroke()),
                                    J = !0;
                                else {
                                    ...
                                    l || J ? (!l && g.connectNullData ? (c.setLineDash && (g.options.nullDataLineDashType || q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(n.x, n.y),
                                    q = g.nullDataLineDashType,
                                    c.setLineDash(p)),
                                    c.lineTo(x, s),
                                    t && b.lineTo(x, s)) : (c.beginPath(),
                                    c.moveTo(x, s),
                                    t && (b.beginPath(),
                                    b.moveTo(x, s))),
                                    J = l = !1) : (c.lineTo(x, s),
                                    ...
                                    u < r.length - 1 && (k !== (r[u].lineColor || C) || q !== (r[u].lineDashType || g.lineDashType)) && (c.stroke(),
                                    c.beginPath(),
                                    c.moveTo(x, s),
                                    k = r[u].lineColor || C,
                                    c.strokeStyle = k,
                                    c.setLineDash && (r[u].lineDashType ? (q = r[u].lineDashType,
                                    c.setLineDash(P(q, g.lineThickness))) : (q = g.lineDashType,
                                    c.setLineDash(h))));
                ...
                X.drawMarkers(f);
                t && (d.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
        ...
        l.prototype.renderStepLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        for (var J = !1, u = 0; u < r.length; u++)
                            if (x = r[u].getTime ? r[u].x.getTime() : r[u].x,
                            !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J)))
                                if ("number" !== typeof r[u].y)
                                    0 < u && !(g.connectNullData || J || l) && (c.stroke(),
                                    t && b.stroke()),
                                    ...
                                    c.setLineDash(h))));
                                    if (0 < r[u].markerSize || 0 < g.markerSize)
                                        y = g.getMarkerProperties(u, x, s, c),
                                        f.push(y),
                                        B = R(B),
                                        t && f.push({
                                            x: x,
            ...
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        ...
                        t && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length)
                        for (s = !1,
                        l = 0; l < r.length; l++)
                            if (u = r[l].getTime ? r[l].x.getTime() : r[l].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !s)))
                                if ("number" !== typeof r[l].y)
                                    0 < l && !s && (g.connectNullData ? b.setLineDash && (0 < z.length && (g.options.nullDataLineDashType || !r[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = p,
                                    q = g.nullDataLineDashType) : (d(z),
                                    z = [])),
                                    s = !0;
                                else {
                                    ...
                                    l < r.length - 1 && (k !== (r[l].lineColor || C) || q !== (r[l].lineDashType || g.lineDashType)) && (k = r[l].lineColor || C,
                                    z[z.length - 1].newStrokeStyle = k,
                                    b.setLineDash && (r[l].lineDashType ? (q = r[l].lineDashType,
                                    z[z.length - 1].newLineDashArray = P(q, g.lineThickness)) : (q = g.lineDashType,
                                    z[z.length - 1].newLineDashArray = h)));
                ...
                X.drawMarkers(n);
                t && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
        ...
        l.prototype.renderColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, A, g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, q = a.axisX.dataInfo.minDiff;
                ...
                for (r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var p = a.dataSeriesIndexes[r]
                      ...
                      , C = h.dataPoints;
                    if (0 < C.length)
                        for (var k = 5 < q && h.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++)
                            if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x,
                            !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
                                ...
                                da(c, n, m, l, u, b, 0, null, k && 0 <= C[f].y, 0 > C[f].y && k, !1, !1, h.fillOpacity);
                                b = h.dataPointIds[f];
                                this._eventManager.objectMap[b] = {
                                    id: b,
                                    objectType: "dataPoint",
        ...
        l.prototype.renderStackedColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = [], n = [], m = [], A = [], g = 0, r, q, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), g = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    ...
                    if (0 < u.length) {
                        ...
                        for (g = 0; g < u.length; g++)
                            if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x,
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y)
                                    m[b] = u[g].y + (m[b] ? m[b] : 0),
                                    0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]),
                                    y = "undefined" !== typeof f[b] ? f[b] : p,
                                    f[b] = q);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y)
                                    A[b] = u[g].y + (A[b] ? A[b] : 0),
                                    y = a.axisY.convertValueToPixel(A[b]),
                                    q = "undefined" !== typeof n[b] ? n[b] : p,
                                    n[b] = y;
                                else if (q = a.axisY.convertValueToPixel(u[g].y),
                                0 <= u[g].y) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                    var k = a.dataSeriesIndexes[C]
                      ...
                      , u = l.dataPoints;
                    if (0 < u.length)
                        for (var s = 5 < h && l.bevelEnabled ? !0 : !1, g = 0; g < u.length; g++)
                            if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x,
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                                r = a.axisX.convertValueToPixel(b);
                                ...
                                0 <= u[g].y) {
                                    ...
                                    y = q + B,
                                    q = p + B,
                                    a.dataSeriesIndexes.length - 1 === C && 1 >= Math.abs(e.y2 - y) && (y = e.y2),
                                    n[b] = B + (y - q);
                                b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
                                da(c, z, q, J, y, b, 0, null, s && 0 <= u[g].y, 0 > u[g].y && s, !1, !1, l.fillOpacity);
                                b = l.dataPointIds[g];
        ...
        l.prototype.renderBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, A, g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, r = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, q = a.axisX.dataInfo.minDiff;
                isFinite(q) || (q = 0.3 * Math.abs(a.axisX.range));
                ...
                return {
                    ...
                    easingFunction: N.easing.easeOutQuart,
                    animationBase: g < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : g > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : g
                }
            }
        }
        ;
                    ...
                    if (0 < u.length) {
                        ...
                        for (g = 0; g < u.length; g++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                                ...
                                else if (r = a.axisY.convertValueToPixel(u[g].y),
                                0 <= u[g].y) {
                                    var B = f[b] ? f[b] : 0;
                                    y = p + B;
                                    r += B;
                                ...
                                b = R(b);
                                t && da(this._eventManager.ghostCtx, y, z, r, J, b, 0, null, !1, !1, !1, !1);
                                (u[g].indexLabel || l.indexLabel || u[g].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    if (0 < u.length) {
                        ...
                        for (g = 0; g < u.length; g++)
                            ...
                            !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                                ...
                                var J = q - a.plotType.plotUnits.length * h / 2 + a.index * h << 0
                                  , y = J + h << 0;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
                                    m[b] = z + (m[b] ? m[b] : 0);
                                    if (0 >= m[b])
                                ...
                                else if (r = a.axisY.convertValueToPixel(z),
                                0 <= u[g].y) {
                                    var B = f[b] ? f[b] : 0;
                                    z = p + B;
                                    r += B;
                                    ...
                                    z = r - B,
                                    r = p - B,
                                    a.dataSeriesIndexes.length - 1 === C && 1 >= Math.abs(e.x1 - z) && (z = e.x1),
                                    n[b] = B + (r - z);
                                b = u[g].color ? u[g].color : l._colorSet[g % l._colorSet.length];
        ...
        l.prototype.renderArea = function(a) {
            var d, c;
            function b() {
                y && (0 < h.lineThickness && f.stroke(),
                a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z),
                f.lineTo(l, J),
                f.lineTo(y.x, J),
                f.closePath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                f.clip();
                t && (n.beginPath(),
                n.rect(g.x1, g.y1, g.width, g.height),
                n.clip());
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    A = [];
                    d = !0;
                    var k = 0, l, u, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), J, y = null;
                    if (0 < C.length) {
                        var B = h._colorSet[k % h._colorSet.length]
                        ...
                        for (var ha = !0; k < C.length; k++)
                            if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ha)))
                                if ("number" !== typeof C[k].y)
                                    h.connectNullData || (ha || d) || b(),
                                    ha = !0;
                                else {
                                    l = a.axisX.convertValueToPixel(s);
                                    u = a.axisY.convertValueToPixel(C[k].y);
                                    d || ha ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l,
                                    c = u,
                                    l = r.x,
                                    u = r.y,
                                    b(),
                                    ...
                                    k < C.length - 1 && (w !== (C[k].lineColor || v) || c !== (C[k].lineDashType || h.lineDashType)) && (b(),
                                    w = C[k].lineColor || v,
                                    f.strokeStyle = w,
                                    f.setLineDash && (C[k].lineDashType ? (c = C[k].lineDashType,
                                    f.setLineDash(P(c, h.lineThickness))) : (c = h.lineDashType,
                                    f.setLineDash(O))));
                                    ...
                                    0 !== C[k].markerSize && (0 < C[k].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(k, l, u, f),
                                    A.push(s),
                                    Z = R(Z),
                                    t && A.push({
                                        x: l,
                ...
                this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height),
                f.clearRect(g.x1, g.y1, g.width, g.height),
                this._eventManager.ghostCtx.restore());
                f.restore();
                return {
                    source: e,
        ...
        l.prototype.renderSplineArea = function(a) {
                ...
                if (0 < c.length) {
                    if (0 < r.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y),
                            t && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    n = R(n);
                    e.fillStyle = n;
                    var n = [], p = 0, h, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l, u = null, s = [];
                    if (0 < q.length) {
                        var z = r._colorSet[p % r._colorSet.length]
                          , J = r.lineColor = r.options.lineColor || z
                          , y = J;
                        b.fillStyle = z;
                        b.strokeStyle = J;
                        ...
                        var B = "solid";
                        if (b.setLineDash) {
                            var w = P(r.nullDataLineDashType, r.lineThickness)
                              , B = r.lineDashType
                              , D = P(B, r.lineThickness);
                            b.setLineDash(D)
                        }
                        for (C = !1; p < q.length; p++)
                            if (h = q[p].x.getTime ? q[p].x.getTime() : q[p].x,
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C)))
                                if ("number" !== typeof q[p].y)
                                    0 < p && !C && (r.connectNullData ? b.setLineDash && (0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = w,
                                    B = r.nullDataLineDashType) : (d(),
                                    s = [])),
                                    C = !0;
                                else {
                                    ...
                                    p < q.length - 1 && (y !== (q[p].lineColor || J) || B !== (q[p].lineDashType || r.lineDashType)) && (y = q[p].lineColor || J,
                                    s[s.length - 1].newStrokeStyle = y,
                                    b.setLineDash && (q[p].lineDashType ? (B = q[p].lineDashType,
                                    s[s.length - 1].newLineDashArray = P(B, r.lineThickness)) : (B = r.lineDashType,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    if (0 < C.length) {
                        ...
                        var L = "solid";
                        if (f.setLineDash) {
                            var O = P(h.nullDataLineDashType, h.lineThickness)
                              , L = h.lineDashType
                              , D = P(L, h.lineThickness);
                            f.setLineDash(D)
                        }
                        for (; k < C.length; k++)
                            if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x,
                            !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
                                var Z = u;
                                "number" !== typeof C[k].y ? (h.connectNullData || (c || d) || b(),
                                c = !0) : (l = a.axisX.convertValueToPixel(s),
                                u = a.axisY.convertValueToPixel(C[k].y),
                                d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || L === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l,
                                c = u,
                                l = r.x,
                                u = r.y,
                                b(),
                                ...
                                u = c,
                                y = r,
                                L = h.nullDataLineDashType,
                                f.setLineDash(O)),
                                f.lineTo(l, Z),
                                f.lineTo(l, u),
                                t && (n.lineTo(l, Z),
                                n.lineTo(l, u))) : (f.beginPath(),
                                f.moveTo(l, u),
                                t && (n.beginPath(),
                                n.moveTo(l, u)),
                                y = {
                                ...
                                k < C.length - 1 && (w !== (C[k].lineColor || v) || L !== (C[k].lineDashType || h.lineDashType)) && (b(),
                                w = C[k].lineColor || v,
                                f.strokeStyle = w,
                                f.setLineDash && (C[k].lineDashType ? (L = C[k].lineDashType,
                                f.setLineDash(P(L, h.lineThickness))) : (L = h.lineDashType,
                                f.setLineDash(D)))),
                                s = h.dataPointIds[k],
                                ...
                                0 !== C[k].markerSize && (0 < C[k].markerSize || 0 < h.markerSize) && (Z = h.getMarkerProperties(k, l, u, f),
                                A.push(Z),
                                s = R(s),
                                t && A.push({
                                    x: l,
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = t ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = [], m = this.plotArea, A = [], g = [], r = [], q = [], p = 0, h, k, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), s = this._eventManager.ghostCtx, u, x, z;
                t && s.beginPath();
                b.save();
                t && s.save();
                b.beginPath();
                ...
                b.clip();
                t && (s.beginPath(),
                s.rect(m.x1, m.y1, m.width, m.height),
                s.clip());
                for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
                    var y = a.dataSeriesIndexes[J]
                      , B = this.data[y]
                      , v = B.dataPoints;
                    B.dataPointIndexes = [];
                ...
                for (J = 0; J < a.dataSeriesIndexes.length; J++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var Z = !0, p = 0; p < r.length; p++) {
                            var f = r[p]
                              , ia = null
                              , ia = 0 <= B.dataPointIndexes[f] ? v[B.dataPointIndexes[f]] : {
                                x: f,
                                y: null
                            };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
                                if ("number" !== typeof ia.y)
                                    B.connectNullData || (Z || x) || d(),
                                    Z = !0;
                                else {
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        q[f] = ia.y + (q[f] ? q[f] : 0);
                                        if (0 >= q[f] && a.axisY.logarithmic)
                                            continue;
                                        k = a.axisY.convertValueToPixel(q[f])
                                    } else
                                        k = a.axisY.convertValueToPixel(ia.y),
                                        k -= na;
                                    g.push({
                                        x: h,
                                        y: l - na
                                    ...
                                    A[f] = l - k;
                                    x || Z ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = g.pop(),
                                    z = g[g.length - 1],
                                    d(),
                                    b.moveTo(u.x, u.y),
                                    g.push(z),
                                    ...
                                    p < v.length - 1 && (L !== (v[p].lineColor || w) || z !== (v[p].lineDashType || B.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(h, k),
                                    g.push({
                                        x: h,
                                    ...
                                    L = v[p].lineColor || w,
                                    b.strokeStyle = L,
                                    b.setLineDash && (v[p].lineDashType ? (z = v[p].lineDashType,
                                    b.setLineDash(P(z, B.lineThickness))) : (z = B.lineDashType,
                                    b.setLineDash(D))));
                                    ...
                                    0 <= B.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (na = B.getMarkerProperties(B.dataPointIndexes[f], h, k, b),
                                    n.push(na),
                                    f = R(E),
                                    t && n.push({
                                        x: h,
        ...
        l.prototype.renderStackedArea100 = function(a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx
              , b = t ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = this.plotArea, m = [], k = [], g = [], r = [], q = [], p = 0, h, l, s, aa, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), z = this._eventManager.ghostCtx;
                b.save();
                t && z.save();
                b.beginPath();
                ...
                b.clip();
                t && (z.beginPath(),
                z.rect(n.x1, n.y1, n.width, n.height),
                z.clip());
                for (var e = [], v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    for (p = 0; p < w.length; p++)
                        y = w[p].x.getTime ? w[p].x.getTime() : w[p].x,
                        B.dataPointIndexes[y] = p,
                        e[y] || (r.push(y),
                        e[y] = !0);
                    r.sort(Pa)
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var Z = !0, p = 0; p < r.length; p++) {
                            var f = r[p]
                              , ia = null
                              , ia = 0 <= B.dataPointIndexes[f] ? w[B.dataPointIndexes[f]] : {
                                x: f,
                                y: null
                            };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
                                if ("number" !== typeof ia.y)
                                    B.connectNullData || (Z || aa) || d(),
                                    Z = !0;
                                else {
                                    var na;
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) {
                                        ...
                                        l = a.axisY.convertValueToPixel(na),
                                        l -= ca;
                                    g.push({
                                        x: h,
                                        y: x - ca
                                    ...
                                    k[f] = x - l;
                                    aa || Z ? (!aa && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (aa = g.pop(),
                                    u = g[g.length - 1],
                                    d(),
                                    b.moveTo(s.x, s.y),
                                    g.push(u),
                                    ...
                                    p < w.length - 1 && (L !== (w[p].lineColor || D) || u !== (w[p].lineDashType || B.lineDashType)) && (d(),
                                    b.beginPath(),
                                    b.moveTo(h, l),
                                    g.push({
                                        x: h,
                                    ...
                                    L = w[p].lineColor || D,
                                    b.strokeStyle = L,
                                    b.setLineDash && (w[p].lineDashType ? (u = w[p].lineDashType,
                                    b.setLineDash(P(u, B.lineThickness))) : (u = B.lineDashType,
                                    b.setLineDash(E))));
                                    if (0 <= B.dataPointIndexes[f]) {
                                    ...
                                    0 <= B.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (ca = B.getMarkerProperties(p, h, l, b),
                                    m.push(ca),
                                    f = R(F),
                                    t && m.push({
                                        x: h,
        ...
        l.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this._eventManager.ghostCtx.clip());
                for (var m = -Infinity, k = Infinity, g = 0; g < a.dataSeriesIndexes.length; g++)
                    for (var r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints, h = 0, e = 0; e < p.length; e++)
                        f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x,
                        f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (h = p[e].z,
                        h > m && (m = h),
                        h < k && (k = h));
                for (var l = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), g = 0; g < a.dataSeriesIndexes.length; g++)
                    if (r = a.dataSeriesIndexes[g],
                    q = this.data[r],
                    p = q.dataPoints,
                    0 < p.length)
                        for (c.strokeStyle = "#4572A7 ",
                        e = 0; e < p.length; e++)
                            if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x,
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        ...
                        for (var q = 0, p = 0, e = 0; e < r.length; e++)
                            if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x,
                            !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((q - f) * (q - f) + (p - n) * (p - n)) < Math.min(h.size, 5) && r.length > Math.min(this.plotArea.width, this.plotArea.height) || (q = g.dataPointIds[e],
                                ...
                                q = R(q),
                                t && X.drawMarker(h.x, h.y, this._eventManager.ghostCtx, h.type, h.size, q, q, h.borderThickness),
                                (r[e].indexLabel || g.indexLabel || r[e].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: "scatter",
                                    dataPoint: r[e],
                                    dataSeries: g,
                                    point: {
        ...
        l.prototype.renderCandlestick = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, n = this.plotArea, m = 0, k, g, r, q, p, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, f = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, l = a.axisX.dataInfo.minDiff;
                ...
                for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                    var aa = a.dataSeriesIndexes[ga]
                      , u = this.data[aa]
                      , x = u.dataPoints;
                    if (0 < x.length)
                        for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++)
                            if (x[m].getTime ? h = x[m].x.getTime() : h = x[m].x,
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] && "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3]) {
                                ...
                                "candlestick" === u.type ? (c.moveTo(k - w, r),
                                c.lineTo(k - w, Math.min(g, p)),
                                c.stroke(),
                                c.moveTo(k - w, Math.max(g, p)),
                                c.lineTo(k - w, q),
                                c.stroke(),
                                da(c, v, Math.min(g, p), y, Math.max(g, p), x[m].y[0] <= x[m].y[3] ? u.risingColor : f, B, e, z, z, !1, !1, u.fillOpacity),
                                t && (e = R(D),
                                b.strokeStyle = e,
                                b.moveTo(k - w, r),
                                b.lineTo(k - w, Math.min(g, p)),
                                b.stroke(),
                                b.moveTo(k - w, Math.max(g, p)),
                                b.lineTo(k - w, q),
                                b.stroke(),
                                da(b, v, Math.min(g, p), y, Math.max(g, p), e, 0, null, !1, !1, !1, !1))) : "ohlc" === u.type && (c.moveTo(k - w, r),
                                c.lineTo(k - w, q),
                                c.stroke(),
                                c.beginPath(),
                                c.moveTo(k, g),
        ...
        l.prototype.renderBoxAndWhisker = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              ...
              , b = this._eventManager.ghostCtx;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = this.plotArea, n = 0, m, k, g, r, q, p, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1, n = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : 0.015 * this.width, l = a.axisX.dataInfo.minDiff;
                isFinite(l) || (l = 0.3 * Math.abs(a.axisX.range));
                ...
                for (var ga = !1, ga = !!a.axisY.reversed, aa = 0; aa < a.dataSeriesIndexes.length; aa++) {
                    var u = a.dataSeriesIndexes[aa]
                      , x = this.data[u]
                      , z = x.dataPoints;
                    if (0 < z.length)
                        for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++)
                            if (z[n].getTime ? h = z[n].x.getTime() : h = z[n].x,
                            !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
                                ...
                                var y = m - l / 2 << 0
                                  ...
                                  , I = z[n].stemDashType ? z[n].stemDashType : x.stemDashType
                                  ...
                                  , S = z[n].lineDashType ? z[n].lineDashType : x.lineDashType
                                ...
                                c.strokeStyle = na,
                                c.lineWidth = ca,
                                c.setLineDash && c.setLineDash(P(I, ca)),
                                c.moveTo(m - F, g),
                                c.lineTo(m - F, k),
                                c.stroke(),
                                c.moveTo(m - F, q),
                                ...
                                c.lineWidth = w;
                                c.strokeStyle = e;
                                c.rect(y - D, Math.min(g, r) - D, B - y + 2 * D, Math.max(g, r) - Math.min(g, r) + 2 * D);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(),
                                c.globalAlpha = 1,
                                c.setLineDash && c.setLineDash(P(S, M)),
                                c.strokeStyle = G,
                                c.lineWidth = M,
                                c.moveTo(y, p - K),
                                c.lineTo(B, p - K),
                                ...
                                c.save();
                                0 < O && (c.beginPath(),
                                c.setLineDash && c.setLineDash(P(E, O)),
                                c.strokeStyle = L,
                                c.lineWidth = O,
                                c.moveTo(m - Z / 2 << 0, q - ia),
                                c.lineTo(m + Z / 2 << 0, q - ia),
                                c.stroke(),
                                c.moveTo(m - Z / 2 << 0, k + ia),
                                c.lineTo(m + Z / 2 << 0, k + ia),
                                c.stroke());
                                c.restore();
                                t && (e = R(Q),
                                b.strokeStyle = e,
                                b.lineWidth = ca,
                                0 < ca && (b.moveTo(m - D - F, g),
                                b.lineTo(m - D - F, Math.max(k, q)),
                                b.stroke(),
                                b.moveTo(m - D - F, Math.min(k, q)),
                                b.lineTo(m - D - F, r),
                                b.stroke()),
                                da(b, y, Math.max(g, r), B, Math.min(g, r), e, 0, null, !1, !1, !1, !1),
                                0 < O && (b.beginPath(),
                                b.lineWidth = O,
                                b.moveTo(m + Z / 2, q - ia),
                                b.lineTo(m - Z / 2, q - ia),
        ...
        l.prototype.renderRangeColumn = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r]
                      ...
                      , h = p.dataPoints;
                    if (0 < h.length)
                        for (var l = 5 < g && p.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)
                            if (h[f].getTime ? k = h[f].x.getTime() : k = h[f].x,
                            !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                                ...
                                if (h[f].indexLabel || p.indexLabel || h[f].indexLabelFormatter || p.indexLabelFormatter)
        ...
        l.prototype.renderError = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                this._eventManager.ghostCtx.clip());
                for (var aa = 0, u = 0; u < this.data.length; u++)
                    !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && aa || aa++;
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var z = a.dataSeriesIndexes[x]
                      ...
                      , D = 0;
                    if (B)
                        for (e = v._linkedSeries.id,
                        u = 0; u < e; u++)
                            !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && D || (this.data[u].type.match(/(range)/ig) && (f = !0),
                            D++);
                    ...
                    f && (m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? aa : 1))) << 0 : 0.03 * this.width);
                    ...
                    u > m && (u = m);
                    if (0 < y.length)
                        for (var E = v._colorSet, m = 0; m < y.length; m++) {
                            var e = v.lineColor = v.options.color ? v.options.color : E[0]
                              , L = {
                                ...
                                trimLength: s(y[m].whiskerLength) ? s(v.options.whiskerLength) ? 50 : 0 : 0
                            };
                            ...
                            if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !s(y[m].y) && y[m].y.length && "number" === typeof y[m].y[0] && "number" === typeof y[m].y[1]) {
                                ...
                                b ? q = ha : h = ha;
                                b ? (p = a.axisX.reversed ? g + (B ? aa : 1) * u / 2 - (B ? D - 1 : 0) * u << 0 : g - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) * u << 0,
                                h = a.axisX.reversed ? p - u << 0 : p + u << 0) : (r = a.axisX.reversed ? k + (B ? aa : 1) * u / 2 - (B ? D - 1 : 0) * u << 0 : k - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) * u << 0,
                                ...
                                w(c, Math.min(r, q), Math.min(p, h), Math.max(q, r), Math.max(h, p), e, L, O, b);
                                t && w(this._eventManager.ghostCtx, r, p, q, h, e, L, O, b);
                                if (y[m].indexLabel || v.indexLabel || y[m].indexLabelFormatter || v.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "error",
                                        dataPoint: y[m],
                                        dataSeries: v,
        ...
        l.prototype.renderRangeBar = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null, e = this.plotArea, f = 0, n, m, k, g, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                    ...
                    if (0 < l.length) {
                        ...
                        for (f = 0; f < l.length; f++)
                            if (l[f].getTime ? g = l[f].x.getTime() : g = l[f].x,
                            !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(l[f].y) && l[f].y.length && "number" === typeof l[f].y[0] && "number" === typeof l[f].y[1]) {
                                ...
                                b = R(b);
                                t && da(this._eventManager.ghostCtx, n, k, m, v, b, 0, null, !1, !1, !1, !1);
                                if (l[f].indexLabel || h.indexLabel || l[f].indexLabelFormatter || h.indexLabelFormatter)
                                    this._indexLabels.push({
                                        chartType: "rangeBar",
                                        dataPoint: l[f],
                                        dataSeries: h,
        ...
        l.prototype.renderRangeArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < q.length) {
                        var z = r._colorSet[h % r._colorSet.length]
                          , w = r.lineColor = r.options.lineColor || z
                          , y = w;
                        b.fillStyle = z;
                        b.strokeStyle = w;
                        b.lineWidth = r.lineThickness;
                        var B = "solid";
                        if (b.setLineDash) {
                            var D = P(r.nullDataLineDashType, r.lineThickness)
                              , B = r.lineDashType
                              , E = P(B, r.lineThickness);
                            b.setLineDash(E)
                        }
                        for (var L = !0; h < q.length; h++)
                            if (u = q[h].x.getTime ? q[h].x.getTime() : q[h].x,
                            !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !L)))
                                if (null !== q[h].y && q[h].y.length && "number" === typeof q[h].y[0] && "number" === typeof q[h].y[1]) {
                                    ...
                                    p || L ? (r.connectNullData && !p ? (b.setLineDash && (r.options.nullDataLineDashType || B === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = E,
                                    ...
                                    h < q.length - 1 && (y !== (q[h].lineColor || w) || B !== (q[h].lineDashType || r.lineDashType)) && (d(),
                                    y = q[h].lineColor || w,
                                    k[k.length - 1].newStrokeStyle = y,
                                    b.strokeStyle = y,
                                    b.setLineDash && (q[h].lineDashType ? (B = q[h].lineDashType,
                                    k[k.length - 1].newLineDashArray = P(B, r.lineThickness),
                                    b.setLineDash(k[k.length - 1].newLineDashArray)) : (B = r.lineDashType,
                                    ...
                                    if (q[h].indexLabel || r.indexLabel || q[h].indexLabelFormatter || r.indexLabelFormatter)
                                        this._indexLabels.push({
                                            chartType: "rangeArea",
                                            dataPoint: q[h],
                                            dataSeries: r,
        ...
        l.prototype.renderRangeSplineArea = function(a) {
            function d(a, c) {
                ...
                if (0 < d.length) {
                    ...
                    for (f = 0; f < d.length - 3; f += 3)
                        b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y),
                        t && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                    d = v(aa, 2);
                    ...
                    if (0 < g.lineThickness) {
                        ...
                        b.beginPath();
                        b.moveTo(d[0].x, d[0].y);
                        for (var h = f = 0; f < d.length - 3; f += 3,
                        h++) {
                            if (s[h].newStrokeStyle || s[h].newLineDashArray)
                                b.stroke(),
                                b.beginPath(),
                                b.moveTo(d[f].x, d[f].y),
                                s[h].newStrokeStyle && (b.strokeStyle = s[h].newStrokeStyle),
                                s[h].newLineDashArray && b.setLineDash(s[h].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                        }
                        b.stroke()
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                    ...
                    if (0 < r.length) {
                        var u = g._colorSet[q % g._colorSet.length]
                          , x = g.lineColor = g.options.lineColor || u
                          , z = x;
                        b.fillStyle = u;
                        b.lineWidth = g.lineThickness;
                        var w = "solid", y;
                        if (b.setLineDash) {
                            var B = P(g.nullDataLineDashType, g.lineThickness)
                              , w = g.lineDashType;
                            y = P(w, g.lineThickness)
                        }
                        for (h = !1; q < r.length; q++)
                            if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x,
                            !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !h)))
                                if (null !== r[q].y && r[q].y.length && "number" === typeof r[q].y[0] && "number" === typeof r[q].y[1]) {
                                    ...
                                    q < r.length - 1 && (z !== (r[q].lineColor || x) || w !== (r[q].lineDashType || g.lineDashType)) && (z = r[q].lineColor || x,
                                    s[s.length - 1].newStrokeStyle = z,
                                    b.setLineDash && (r[q].lineDashType ? (w = r[q].lineDashType,
                                    s[s.length - 1].newLineDashArray = P(w, g.lineThickness)) : (w = g.lineDashType,
                                    ...
                                    if (r[q].indexLabel || g.indexLabel || r[q].indexLabelFormatter || g.indexLabelFormatter)
                                        this._indexLabels.push({
                                    ...
                                    0 < q && !h && (g.connectNullData ? b.setLineDash && (0 < s.length && (g.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = B,
                                    w = g.nullDataLineDashType) : (d(y, x),
                                    s = [],
                                    aa = [])),
                                    h = !0;
                        d(y, x);
        ...
        l.prototype.renderWaterfall = function(a) {
            var d = a.targetCanvasCtx || this.plotArea.ctx
              , c = t ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx, e = null, f = this.plotArea, n = 0, m, k, g, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), n = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < v.length)
                        for (var z = 5 < p && s.bevelEnabled ? !0 : !1, w = !1, y = null, B = null, n = 0; n < v.length; n++)
                            if (v[n].getTime ? r = v[n].x.getTime() : r = v[n].x,
                            "number" !== typeof v[n].y) {
                                if (0 < n && !w && s.connectNullData)
                                    var D = s.options.nullDataLineDashType || !v[n - 1].lineDashType ? s.nullDataLineDashType : v[n - 1].lineDashType;
                                w = !0
                            } else {
                                ...
                                m = a.axisX.reversed ? m + a.plotType.totalDataSeries * p / 2 - (a.previousDataSeriesCount + h) * p << 0 : m - a.plotType.totalDataSeries * p / 2 + (a.previousDataSeriesCount + h) * p << 0;
                                ...
                                e = R(e);
                                t && da(this._eventManager.ghostCtx, m, k, E, g, e, 0, null, !1, !1, !1, !1);
                                var O, L = m;
                                ...
                                0 < n && y && (!w || s.connectNullData) && (w && c.setLineDash && c.setLineDash(P(D, u)),
                                c.beginPath(),
                                c.moveTo(y, B - x),
                                c.lineTo(L, O - x),
                                0 < u && c.stroke(),
                                ...
                                y = E;
                                B = 0 < v[n].y ? k : g;
                                L = v[n].lineDashType ? v[n].lineDashType : s.options.lineDashType ? s.options.lineDashType : "shortDash";
                                c.strokeStyle = v[n].lineColor ? v[n].lineColor : s.options.lineColor ? s.options.lineColor : "#9e9e9e";
                                c.lineWidth = u;
                                c.setLineDash && (L = P(L, u),
                                c.setLineDash(L));
        ...
        l.prototype.renderPie = function(a) {
                ...
                if (g && r) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
                        ...
                        var m = h[e]
                          ...
                          , l = null
                          , q = k.getPercentAndTotal(g, f);
                        if (g.indexLabelFormatter || f.indexLabelFormatter)
                            l = {
                                chart: k.options,
                                dataSeries: g,
                                dataPoint: f,
                        ...
                        q = f.indexLabelFormatter ? f.indexLabelFormatter(l) : f.indexLabel ? k.replaceKeywordsWithValue(f.indexLabel, f, g, e) : g.indexLabelFormatter ? g.indexLabelFormatter(l) : g.indexLabel ? k.replaceKeywordsWithValue(g.indexLabel, f, g, e) : f.label ? f.label : "";
                        ...
                        m.indexLabelLineColor = f.indexLabelLineColor ? f.indexLabelLineColor : g.options.indexLabelLineColor ? g.options.indexLabelLineColor : f.color ? f.color : g._colorSet[e % g._colorSet.length];
                        ...
                        m.indexLabelFontSize = s(f.indexLabelFontSize) ? g.indexLabelFontSize : f.indexLabelFontSize;
                        ...
                        m.indexLabelWrap = "undefined" !== typeof f.indexLabelWrap ? f.indexLabelWrap : g.indexLabelWrap;
                        ...
                        if (m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u) {
                            if (0 === a || h[c].midAngle > m.midAngle)
                                c = e;
                            a++
                        } else if (m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u) {
                            if (0 === b || h[d].midAngle > m.midAngle)
                                d = e;
                            b++
                        }
                    ...
                    for (e = 0; e < r.length; e++)
                        m = h[(c + e) % r.length],
                        1 < a && (m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u) && (f <= a / 2 && !q ? (m.hemisphere = "right",
                        f++) : (m.hemisphere = "left",
                        q = !0));
                    q = !1;
                    for (e = 0; e < r.length; e++)
                        m = h[(d + e) % r.length],
                        1 < b && (m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u) && (n <= b / 2 && !q ? (m.hemisphere = "left",
                        n++) : (m.hemisphere = "right",
                        q = !0))
                }
            }
            function c(a) {
                ...
                for (b = 0; b < r.length; b++) {
                    var c = h[b].startAngle
                      , d = h[b].endAngle;
                    if (d > c) {
                        var e = 0.07 * B * Math.cos(h[b].midAngle)
                          , f = 0.07 * B * Math.sin(h[b].midAngle)
                          , m = !1;
                        if (r[b].exploded) {
                            if (1E-9 < Math.abs(h[b].center.x - (z.x + e)) || 1E-9 < Math.abs(h[b].center.y - (z.y + f)))
                                h[b].center.x = z.x + e * a,
                                h[b].center.y = z.y + f * a,
                                m = !0
                        } else if (0 < Math.abs(h[b].center.x - z.x) || 0 < Math.abs(h[b].center.y - z.y))
                            h[b].center.x = z.x + e * (1 - a),
                            h[b].center.y = z.y + f * (1 - a),
                            m = !0;
                        m && (e = {},
                        e.dataSeries = g,
                        e.dataPoint = g.dataPoints[b],
                        e.index = b,
                ...
                for (b = b = 0; b < r.length; b++)
                    ...
                    d = 0,
                    d = "left" === c.hemisphere ? "inside" !== g.indexLabelPlacement ? -(c.indexLabelTextBlock.width + q) : -c.indexLabelTextBlock.width / 2 : "inside" !== g.indexLabelPlacement ? q : -c.indexLabelTextBlock.width / 2,
                    c.indexLabelTextBlock.x += d,
                    c.indexLabelTextBlock.render(!0),
                    c.indexLabelTextBlock.x -= d,
                    c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2,
                    "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + B * Math.cos(c.midAngle),
                    e = c.center.y + B * Math.sin(c.midAngle),
                    a.strokeStyle = c.indexLabelLineColor,
                    a.lineWidth = c.indexLabelLineThickness,
                    a.setLineDash && a.setLineDash(P(c.indexLabelLineDashType, c.indexLabelLineThickness)),
                    a.beginPath(),
                    a.moveTo(d, e),
            ...
            function e(a) {
                for (var c = null, d = 1; d < r.length; d++)
                    if (c = (a + d + h.length) % h.length,
                    h[c].hemisphere !== h[a].hemisphere) {
                        c = null;
                        break
                    } else if (h[c].indexLabelText && c !== a && (0 > b(h[c], h[a]) || ("right" === h[a].hemisphere ? h[c].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[c].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y)))
                        break;
                    else
                        c = null;
                return c
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < r.length) {
                    var k = h[a];
                    if (0 > c && k.indexLabelTextBlock.y < m || 0 < c && k.indexLabelTextBlock.y > n)
                        return 0;
                    var p = 0
                      , q = 0
                      , q = p = p = 0;
                    ...
                    for (n = 1; n < r.length; n++)
                        if (m = (a - n + h.length) % h.length,
                        h[m].hemisphere !== h[a].hemisphere) {
                            m = null;
                            break
                        } else if (h[m].indexLabelText && h[m].hemisphere === h[a].hemisphere && m !== a && (0 > b(h[m], h[a]) || ("right" === h[a].hemisphere ? h[m].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[m].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y)))
                            break;
                        else
                            m = null;
                    q = m;
                    p = e(a);
                    n = m = 0;
                    0 > c ? (n = "right" === k.hemisphere ? q : p,
                    g = c,
                    null !== n && (q = -c,
                    c = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (h[n].indexLabelTextBlock.y + h[n].indexLabelTextBlock.height / 2),
                    c - q < l && (m = -q,
                    n = f(n, m, d + 1),
                    +n.toFixed(x) > +m.toFixed(x) && (g = c > l ? -(c - l) : -(q - (n - m)))))) : 0 < c && (n = "right" === k.hemisphere ? p : q,
                    g = c,
                    null !== n && (q = c,
                    c = h[n].indexLabelTextBlock.y - h[n].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2),
                    c - q < l && (m = q,
                    n = f(n, m, d + 1),
                    +n.toFixed(x) < +m.toFixed(x) && (g = c > l ? c - l : q - (m - n)))));
                    g && (d = k.indexLabelTextBlock.y + g,
                    c = 0,
                    c = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)),
                    k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (m = (a - 1 + h.length) % h.length,
                    m = h[m],
                    a = h[(a + 1 + h.length) % h.length],
                    "left" === k.hemisphere && "right" === m.hemisphere && c > m.indexLabelTextBlock.x ? c = m.indexLabelTextBlock.x - 15 : "right" === k.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : k.midAngle > 3 * Math.PI / 2 - u && k.midAngle < 3 * Math.PI / 2 + u && (m = (a - 1 + h.length) % h.length,
                    m = h[m],
                    a = h[(a + 1 + h.length) % h.length],
                    "right" === k.hemisphere && "left" === m.hemisphere && c < m.indexLabelTextBlock.x ? c = m.indexLabelTextBlock.x + 15 : "left" === k.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)),
                    k.indexLabelTextBlock.y = d,
                    k.indexLabelTextBlock.x = c,
                    k.indexLabelAngle = Math.atan2(k.indexLabelTextBlock.y - z.y, k.indexLabelTextBlock.x - z.x))
                }
                return g
            }
            function n() {
                ...
                for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (g.radius || !g.radius && "undefined" !== typeof g.innerRadius && null !== g.innerRadius && B - d <= D)
                        m = !1;
                    m && (B -= d);
                    d = 0;
                        ...
                        for (var u, s, a = 0; a < r.length; a++) {
                            ...
                            if (null !== y) {
                                ...
                                var w = 0
                                  , w = b(u, s) - l;
                                if (0 > w) {
                                    for (var J = s = 0, I = 0; I < r.length; I++)
                                        I !== a && h[I].hemisphere === n.hemisphere && (h[I].indexLabelTextBlock.y < n.indexLabelTextBlock.y ? s++ : J++);
                                    s = w / (s + J || 1) * J;
                                    var J = -1 * (w - s)
                                      , G = I = 0;
                                    "right" === n.hemisphere ? (I = f(a, s),
                                    J = -1 * (w - I),
                                    G = f(y, J),
                                    +G.toFixed(x) < +J.toFixed(x) && +I.toFixed(x) <= +s.toFixed(x) && f(a, -(J - G))) : (I = f(y, s),
                                    J = -1 * (w - I),
                                    G = f(a, J),
                                    +G.toFixed(x) < +J.toFixed(x) && +I.toFixed(x) <= +s.toFixed(x) && f(y, -(J - G)))
                                }
                            }
                        }
                    } else
                    ...
                    for (a = 0; a < r.length; a++)
                        ...
                        0 !== y.height && 0 !== y.width)
                            y = y = 0,
                            "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width + q),
                            y *= -1) : y = p.x1 - (n.indexLabelTextBlock.x - n.indexLabelTextBlock.width - q),
                            0 < y && (!m && n.indexLabelText && (s = "right" === n.hemisphere ? p.x2 - n.indexLabelTextBlock.x : n.indexLabelTextBlock.x - p.x1,
                            0.3 * n.indexLabelTextBlock.maxWidth > s ? n.indexLabelText = "" : n.indexLabelTextBlock.maxWidth = 0.85 * s,
                            0.3 * n.indexLabelTextBlock.maxWidth < s && (n.indexLabelTextBlock.x -= "right" === n.hemisphere ? 2 : -2)),
                            Math.abs(n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - z.y) < B || Math.abs(n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 - z.y) < B) && (y /= Math.abs(Math.cos(n.indexLabelAngle)),
                            9 < y && (y *= 0.3),
                            y > d && (d = y)),
                            y = y = 0,
                            0 < n.indexLabelAngle && n.indexLabelAngle < Math.PI ? (y = p.y2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2 + 5),
                            y *= -1) : y = p.y1 - (n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - 5),
                            0 < y && (!m && n.indexLabelText && (s = 0 < n.indexLabelAngle && n.indexLabelAngle < Math.PI ? -1 : 1,
                            0 === f(a, y * s) && f(a, 2 * s)),
                            Math.abs(n.indexLabelTextBlock.x - z.x) < B && (y /= Math.abs(Math.sin(n.indexLabelAngle)),
                            9 < y && (y *= 0.3),
                            y > d && (d = y)));
                    var K = function(a, b, c) {
                        for (var d = [], e = 0; d.push(h[b]),
                        b !== c; b = (b + 1 + r.length) % r.length)
                            ;
                        d.sort(function(a, b) {
                            return a.y - b.y
                        });
                    ...
                    (function() {
                        for (var a = -1, c = -1, d = 0, f = !1, g = 0; g < r.length; g++)
                            if (f = !1,
                            u = h[g],
                            u.indexLabelText) {
                                var n = e(g);
                                if (null !== n) {
                                    ...
                                    n !== a && (c = n,
                                    d += -w),
                                    0 === g % Math.max(r.length / 10, 3) && (f = !0)) : f = !0;
                                    f && (0 < d && 0 <= a && 0 <= c) && (K(d, a, c),
                                    c = a = -1,
                                    d = 0)
                                }
                            }
            ...
            var k = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var g = this.data[a.dataSeriesIndexes[0]], r = g.dataPoints, q = 10, p = this.plotArea, h = g.dataPointEOs, l = 2, t, v = 1.3, u = 20 / 180 * Math.PI, x = 6, z = {
                    x: (p.x2 + p.x1) / 2,
                    y: (p.y2 + p.y1) / 2
                }, w = 0;
                a = !1;
                for (var y = 0; y < r.length; y++)
                    w += Math.abs(r[y].y),
                    !a && ("undefined" !== typeof r[y].indexLabel && null !== r[y].indexLabel && 0 < r[y].indexLabel.toString().length) && (a = !0),
                    !a && ("undefined" !== typeof r[y].label && null !== r[y].label && 0 < r[y].label.toString().length) && (a = !0);
                if (0 !== w) {
                    a = a || "undefined" !== typeof g.indexLabel && null !== g.indexLabel && 0 < g.indexLabel.toString().length;
                    var B = "inside" !== g.indexLabelPlacement && a ? 0.75 * Math.min(p.width, p.height) / 2 : 0.92 * Math.min(p.width, p.height) / 2;
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        k.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint,
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (b = 0; b < r.length; b++) {
                            var c = 0 === b ? h[b].startAngle : d
                              , d = c + (h[b].endAngle - h[b].startAngle)
                              , e = !1;
                            d > a && (d = a,
                            e = !0);
        ...
        l.prototype.renderFunnel = function(a) {
            ...
            function c() {
                ...
                if (0 === h)
                    return -1;
                for (var n = d[0] = 0, m = 0, k, r, b = b - a, n = !1, g = 0; g < x.length; g++)
                    a = Math.abs(x[g].y) * f / h,
                    n ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (r = ba * ba * b * b - 4 * Math.abs(ba) * a,
                    0 > r ? (r = c,
                    n = (b + r) * (e - m) / 2,
                    a -= n,
                    k = e - m,
                    ...
                    k += 0 == r ? 0 : a / r,
                    m += a / r,
                    n = !0) : (k = (Math.abs(ba) * b - Math.sqrt(r)) / 2,
                    r = b - 2 * k / Math.abs(ba),
                    m += k,
                    m > e && (m -= k,
                    r = c,
            ...
            function b() {
                if (u && x) {
                    for (var a, b, c, d, e, f, g, m, n, k, r, p, q, l, A = [], C = [], v = {
                        percent: null,
                        total: null
                    }, z = null, y = 0; y < x.length; y++)
                        l = Q[y],
                        l = "undefined" !== typeof l.x5 ? (l.y2 + l.y4) / 2 : (l.y2 + l.y3) / 2,
                        l = h(l).x2 + 1,
                        A[y] = M - l - V;
                    l = 0.5 * V;
                    for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++,
                    B--) {
                        ...
                        "inside" === u.indexLabelPlacement && (A[y] = y !== da ? u.reversed ? Q[y].x2 - Q[y].x1 : Q[y].x3 - Q[y].x4 : Q[y].x3 - Q[y].x6,
                        20 > A[y] && (A[y] = y !== da ? u.reversed ? Q[y].x3 - Q[y].x4 : Q[y].x2 - Q[y].x1 : Q[y].x2 - Q[y].x1,
                        A[y] /= 2));
            ...
            function e() {
                ...
                if (e)
                    for (m = H.length - 1; 0 <= m; m--)
                        ...
                        u.reversed ? (H[m].textBlock.y + H[m].height > T + D && (H[m].textBlock.y = T + D - H[m].height),
                        H[m].textBlock.y < sa - D && (H[m].textBlock.y = sa - D)) : (H[m].textBlock.y < T - D && (H[m].textBlock.y = T - D),
                        H[m].textBlock.y + H[m].height > sa + D && (H[m].textBlock.y = sa + D - H[m].height))
            }
            function f() {
                var a, b, c, d;
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < Q.length; e++)
                        0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e],
                        c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2,
                        b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? h(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? h(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1,
                        H[e].textBlock.x = b + V,
                        H[e].textBlock.y = c - H[e].height / 2,
                        u.reversed ? (H[e].textBlock.y + H[e].height > T + D && (H[e].textBlock.y = T + D - H[e].height),
                        H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < T - D && (H[e].textBlock.y = T - D),
                        H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
                else
            ...
            function n() {
                ...
                function b() {
                    ...
                    for (var m, n = 1; n < g; n++) {
                        ...
                        for (var r = H.length - 1; 0 <= r; r--)
                            !H[r].isDirty && (H[r].textBlock.y < e && H[r].textBlock.y + H[r].height > e) && (m = p(r),
                            !(m >= H.length - 1) && H[r].textBlock.y + H[r].height + ea > H[m].textBlock.y && (H[r].textBlock.y = H[r].textBlock.y + H[r].height - e > e - H[r].textBlock.y ? e + 1 : e - H[r].height - 1))
                    }
                    for (m = Q.length - 1; 0 < m; m--)
                        if (!H[m].isDirty) {
                            e = q(m);
                            if (0 > e && (e = 0,
                            H[e].isDirty))
                ...
                for (var d, e, f, h, g, n, k = 1, r = 0; r < 2 * k; r++) {
                    for (var l = H.length - 1; 0 <= l && !(0 <= q(l) && q(l),
                    f = H[l],
                    h = f.textBlock,
                    n = (g = p(l) < Q.length ? H[p(l)] : null) ? g.textBlock : null,
                    d = +f.height.toFixed(6),
                    e = +h.y.toFixed(6),
                    !f.isDirty && (g && e + d + ea > +n.y.toFixed(6)) && (d = h.y + d + ea - n.y,
                    e = a(l, -d),
                    e < d && (0 < e && (d -= e),
                    e = a(p(l), d),
                    e != d))); l--)
            ...
            function k(a, b, c) {
                var d, e, h, m = [], n = D, q = [];
                -1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b),
                Y.splice(e, 1)) : (Y.push(b),
                ...
                if (0 === Y.length)
                    ...
                    for (var p = 0; p < Q.length; p++) {
                        if (1 == Y.length && 0 == Y[0]) {
                            ...
                            0 === p && (d = -1 * n);
                        m.push(ja[p] + d);
                        if (0 <= Y.indexOf(p) || p < Q.length && 0 <= Y.indexOf(p + 1))
                            d += e
                    }
                }
                h = function() {
                ...
                a._animator.animate(0, c, function(c) {
                    ...
                    for (e = 0; e < Q.length; e++)
                        qa(d, Q[e], u.fillOpacity);
                    v(d);
                    L && ("inside" !== u.indexLabelPlacement ? r(d) : f(),
                    l(d));
                    1 <= c && (ka = !1)
                }, null, N.easing.easeOutQuart)
            }
            function g() {
                for (var a = 0, b = 0; b < Q.length - 1; b++)
                    (0 <= Y.indexOf(b) || 0 <= Y.indexOf(b + 1)) && a++;
                return a
            }
            function r(a) {
                for (var b, c, d, e, f = 0; f < Q.length; f++)
                    e = 1 === H[f].lineThickness % 2 ? 0.5 : 0,
                    c = ((Q[f].y2 + Q[f].y4) / 2 << 0) + e,
                    b = h(c).x2 - 1,
                    d = H[f].textBlock.x,
                    e = (H[f].textBlock.y + H[f].height / 2 << 0) + e,
                    H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor,
                    a.lineWidth = H[f].lineThickness,
                    a.setLineDash && a.setLineDash(P(H[f].lineDashType, H[f].lineThickness)),
                    a.beginPath(),
                    a.moveTo(b, c),
                    a.lineTo(d, e),
                    a.stroke())
            ...
            function l(a) {
                for (var b = 0; b < Q.length; b++)
                    H[b].isDirty || (a && (H[b].textBlock.ctx = a),
                    H[b].textBlock.render(!0))
            }
            function v(a) {
                w.plotArea.layoutManager.reset();
                a.roundRect || Ba(a);
                w.title && (w.title.dockInsidePlotArea || "center" === w.title.horizontalAlign && "center" === w.title.verticalAlign) && (w.title.ctx = a,
                w.title.render());
                if (w.subtitles)
                ...
                w.legend && (w.legend.dockInsidePlotArea || "center" === w.legend.horizontalAlign && "center" === w.legend.verticalAlign) && (w.legend.ctx = a,
                w.legend.setLayout(),
                w.legend.render());
                I.fNg && I.fNg(w)
            }
            var w = this;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, G = Math.min(z.width - 2 * y, 2.8 * z.height), L = !1, O = 0; O < x.length; O++)
                    if (!L && ("undefined" !== typeof x[O].indexLabel && null !== x[O].indexLabel && 0 < x[O].indexLabel.toString().length) && (L = !0),
                    !L && ("undefined" !== typeof x[O].label && null !== x[O].label && 0 < x[O].label.toString().length) && (L = !0),
                    !L && "function" === typeof u.indexLabelFormatter || "function" === typeof x[O].indexLabelFormatter)
                        L = !0;
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    a = 75 * G / 100;
                    var V = 30 * (M - a) / 100;
                    "funnel" === u.type ? (ca = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight,
                    F = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth,
                    "string" === typeof ca && ca.match(/%$/) ? (ca = parseInt(ca),
                    ca = ca * E / 100) : ca = parseInt(ca),
                    "string" === typeof F && F.match(/%$/) ? (F = parseInt(F),
                    F = F * a / 100) : F = parseInt(F),
                    ca > E ? ca = E : 0 >= ca && (ca = 0),
                    F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = ca = 0,
                    u.reversed = u.reversed ? !1 : !0);
                    var y = O + a / 2
                      , W = O
                      , $ = O + a
                      , T = u.reversed ? S : Z
                      , K = y - F / 2
                      , X = y + F / 2
                      , xa = u.reversed ? Z + ca : S - ca
                      , sa = u.reversed ? Z : S;
                    a = [];
                    var y = [], Q = [], G = [], U = Z, da, ba = (xa - T) / (K - W), fa = -ba, O = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                    if (-1 !== O) {
                        if (u.reversed)
                            for (G.push(U),
                            F = O.length - 1; 0 < F; F--)
                        ...
                        if (u.reversed)
                            for (F = 0; F < O.length; F++)
                                G[F] < xa ? (a.push(K),
                                y.push(X),
                                da = F) : (a.push((G[F] - T + ba * W) / ba),
                                y.push((G[F] - T + fa * $) / fa));
                        else
                            for (F = 0; F < O.length; F++)
                                G[F] < xa ? (a.push((G[F] - T + ba * W) / ba),
                                y.push((G[F] - T + fa * $) / fa),
                                da = F) : (a.push(K),
                                y.push(X));
                        for (F = 0; F < O.length - 1; F++)
                            U = u.reversed ? x[x.length - 1 - F].color ? x[x.length - 1 - F].color : u._colorSet[(x.length - 1 - F) % u._colorSet.length] : x[F].color ? x[F].color : u._colorSet[F % u._colorSet.length],
                            F === da ? Q.push({
                                x1: a[F],
                                y1: G[F],
                                x2: y[F],
                        ...
                        for (F = 0; F < x.length; F++)
                            x[F].exploded && (O = !0,
                            u.reversed ? Y.push(x.length - 1 - F) : Y.push(F));
                        ...
                        "inside" !== u.indexLabelPlacement)) {
                            n();
                            for (F = 0; F < x.length; F++)
                                H[F].isDirty || (a = H[F].textBlock.x + H[F].width,
                                a = (M - a) / 2,
                                0 == F && (B = a),
                                B > a && (B = a));
                        ...
                        for (F = 0; F < Q.length; F++)
                            B = Q[F],
                            qa(R, B, u.fillOpacity),
                            ja.push(B.y1);
                        v(R);
                        L && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled || r(R),
                        ...
                        this.funnelPyramidClickHandler = function(a) {
                            var b = -1;
                            if (!ka && !w.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? x.length - 1 - a.dataPointIndex : a.dataPointIndex,
                            0 <= b)) {
                                a = b;
        ...
        l.prototype.set = function(a, d, c) {
            ...
            c && this.render()) : l.base.set.call(this, a, d, c)
        }
        ;
            ...
            if (b && d && c) {
                ...
                if (!e)
                    try {
                        ...
                        d = window.open(),
                        d.document.write("<img src='" + b + "'></img><div>Please right click on the image and save it to your device</div>"),
                        d.document.close()
                    }
            }
        }
        ...
        l.prototype.getPercentAndTotal = function(a, d) {
            ...
            if (0 <= a.type.indexOf("stacked"))
                ...
                c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c],
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type || "funnel" === c.type || "pyramid" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
                ...
                do {
                    ...
                    if (c.percentFormatString)
                        k = c.percentFormatString;
                    else {
                        var k = "#,##0."
                          , g = Math.max(Math.ceil(Math.log(1 / Math.abs(n)) / Math.LN10), 2);
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                try {
                    var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                    h && 0 < h.length && (g = Fa(h[2]),
                    a = Fa(h[1]))
                } catch (m) {}
                h = null;
                if ("color" === a)
                    return "waterfall" === c.type ? d.color ? d.color : 0 < d.y ? c.risingColor : c.fallingColor : "error" === c.type ? c.color ? c.color : c._colorSet[g % c._colorSet.length] : d.color ? d.color : c.color ? c.color : c._colorSet[b % c._colorSet.length];
                ...
                if ("x" === a)
                    if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                        if (f.plotInfo.plotTypes[0].plotUnits[0].axisX && !f.plotInfo.plotTypes[0].plotUnits[0].axisX.logarithmic)
                            return Aa(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = f.axisX && f.axisX.autoValueFormatString ? f.axisX.autoValueFormatString : "DD MMM YY", f._cultureInfo)
                    } else
                        return fa(h, d.xValueFormatString ? d.xValueFormatString : c.xValueFormatString ? c.xValueFormatString : c.xValueFormatString = "#,##0.########", f._cultureInfo);
                else
                    return "y" === a ? fa(h, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? fa(h, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : h
            })
        }
        ;
        oa(E, W);
        E.prototype.setLayout = function() {
            ...
            n = this.maxHeight = null !== this.maxHeight ? this.maxHeight : 0.5 * d.height) : "center" === this.verticalAlign && (this.orientation = "vertical",
            ...
            for (var r = 0; r < this.dataSeries.length; r++) {
                ...
                if (q.dataPoints && q.dataPoints.length)
                    if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                        var p = q.legendMarkerType = q.legendMarkerType ? q.legendMarkerType : "line" !== q.type && "stepLine" !== q.type && "spline" !== q.type && "scatter" !== q.type && "bubble" !== q.type || !q.markerType ? "error" === q.type && q._linkedSeries ? q._linkedSeries.legendMarkerType ? q._linkedSeries.legendMarkerType : G.getDefaultLegendMarker(q._linkedSeries.type) : G.getDefaultLegendMarker(q.type) : q.markerType
                        ...
                        for (var x = 0; x < q.dataPoints.length; x++) {
                            var z = q.dataPoints[x]
                              ...
                              , h = this.chart.replaceKeywordsWithValue(h, z, q, x)
                              , p = {
                                markerType: p,
                                markerColor: l,
                                text: h,
            ...
            if (0 < k.length) {
                ...
                for (r = 0; r < k.length; r++) {
                    ...
                    if (!(0 >= n || "undefined" === typeof n || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!q || q.width + Math.round(p.textBlock.width + t + m + (0 === q.width ? 0 : this.horizontalSpacing) + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f)
                                q = {
                                    items: [],
                                    width: 0
                                },
                            ...
                            p.textBlock.measureText(),
                            null !== this.itemWidth && (p.textBlock.width = this.itemWidth - (t + m + ("line" === p.chartType || "spline" === p.chartType || "stepLine" === p.chartType ? 2 * 0.1 * this.lineHeight : 0))),
                            this.height < n - this.lineHeight ? (q = {
                                items: [],
                                width: 0
                            },
                            g.push(q)) : (q = g[x],
                ...
                this.itemWidth = l;
                this.height = !1 === this.itemWrap ? g.length * this.lineHeight : this.height + h;
            ...
            for (var m = 0, k = 0; k < n.length; k++) {
                for (var g = n[k], r = 0, q = 0; q < g.items.length; q++) {
                    ...
                    if ("line" === p.chartType || "stepLine" === p.chartType || "spline" === p.chartType)
                        ...
                        this.ctx.beginPath(),
                        this.ctx.moveTo(h - 0.1 * this.lineHeight, l + this.lineHeight / 2),
                        this.ctx.lineTo(h + 0.85 * this.lineHeight, l + this.lineHeight / 2),
                        this.ctx.stroke(),
                    ...
                    if ("error" === p.chartType) {
                        ...
                        this.ctx.beginPath();
                        var t = h - 0.08 * this.lineHeight + 0.1 * this.lineHeight
                    ...
                    X.drawMarker(h + f / 2, l + this.lineHeight / 2, this.ctx, p.markerType, "error" === p.chartType || "line" === p.chartType || "spline" === p.chartType ? p.markerSize / 2 : p.markerSize, p.markerColor, p.markerBorderColor, p.markerBorderThickness);
                    p.textBlock.x = h + c + f;
                    if ("line" === p.chartType || "stepLine" === p.chartType || "spline" === p.chartType)
        ...
        G.prototype.getDataPointAtX = function(a, d) {
            ...
            var c = {
              ...
              , g = 0
              , r = 0;
            "none" !== this.chart.plotInfo.axisPlacement && (this.axisX.logarithmic ? (r = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x),
            r = 1 < r ? Math.min(Math.max((this.dataPoints.length - 1) / r * Math.log(a / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0) : (r = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
            r = 0 < r ? Math.min(Math.max((this.dataPoints.length - 1) / r * (a - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0));
            for (; ; ) {
                f = 0 < n ? r + e : r - e;
                if (0 <= f && f < this.dataPoints.length) {
                    var b = this.dataPoints[f]
                      , q = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x : Math.abs(b.x - a);
                    q < c.distance && (c.dataPoint = b,
                    c.distance = q,
                    c.index = f);
                    b = q;
                    b <= m ? m = b : 0 < n ? k++ : g++;
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                this.axisX.logarithmic)
                    var p = Math.log(this.dataPoints[this.dataPoints.length - 1].x / this.dataPoints[0].x)
                      , q = 1 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * Math.log(q / this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
                else
                    p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x,
                    q = 0 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * (q - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (; ; ) {
                f = 0 < n ? q + e : q - e;
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (p) {
                        ...
                        case "doughnut":
                            ...
                            l < p.radius && l > t && (l = Math.atan2(d - s.y, a - s.x),
                            0 > l && (l += 2 * Math.PI),
                            l = Number(((180 * (l / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            s = Number(((180 * (p.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                            t = Number(((180 * (p.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)),
                        ...
                        case "pyramid":
                            l = p.funnelSection;
                            d > l.y1 && d < l.y4 && (l.y6 ? d > l.y6 ? (f = l.x6 + (l.x5 - l.x6) / (l.y5 - l.y6) * (d - l.y6),
                            l = l.x3 + (l.x4 - l.x3) / (l.y4 - l.y3) * (d - l.y3)) : (f = l.x1 + (l.x6 - l.x1) / (l.y6 - l.y1) * (d - l.y1),
                            l = l.x2 + (l.x3 - l.x2) / (l.y3 - l.y2) * (d - l.y2)) : (f = l.x1 + (l.x4 - l.x1) / (l.y4 - l.y1) * (d - l.y1),
                            l = l.x2 + (l.x3 - l.x2) / (l.y3 - l.y2) * (d - l.y2)),
                            a > f && a < l && (b.push({
                                dataPoint: h,
                                dataPointIndex: p.dataPointIndex,
                                dataSeries: this,
                            ...
                            break;
                        case "boxAndWhisker":
                            if (a >= p.x1 - p.borderThickness / 2 && a <= p.x2 + p.borderThickness / 2 && d >= p.y4 - p.borderThickness / 2 && d <= p.y1 + p.borderThickness / 2 || Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y1 && d <= p.y4)
                                b.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
                            ...
                            break;
                        case "candlestick":
                            if (a >= p.x1 - p.borderThickness / 2 && a <= p.x2 + p.borderThickness / 2 && d >= p.y2 - p.borderThickness / 2 && d <= p.y3 + p.borderThickness / 2 || Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y1 && d <= p.y4)
                                b.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
                            ...
                            break;
                        case "ohlc":
                            if (Math.abs(p.x2 - a + p.x1 - a) < p.borderThickness && d >= p.y2 && d <= p.y3 || a >= p.x1 && a <= (p.x2 + p.x1) / 2 && d >= p.y1 - p.borderThickness / 2 && d <= p.y1 + p.borderThickness / 2 || a >= (p.x1 + p.x2) / 2 && a <= p.x2 && d >= p.y4 - p.borderThickness / 2 && d <= p.y4 + p.borderThickness / 2)
                                b.push({
                                    dataPoint: h,
                                    dataPointIndex: f,
                                    dataSeries: this,
        ...
        D.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.labels) {
                    a = Math.ceil(b);
                    for (var b = Math.ceil(this.intervalStartPosition), h = !1, c = b; c < this.viewportMaximum; c += a)
                        if (this.labels[c])
                            h = !0;
                        else {
                            h = !1;
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    ...
                    b = 0,
                    h = p; b < this.logLabelValues.length; b++)
                        if (c = this.logLabelValues[b],
                        c < this.viewportMinimum)
                            b++;
                        else {
                            ...
                            }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : fa(l, this.valueFormatString, this.chart._cultureInfo),
                            a = new la(this.ctx,{
                                x: 0,
                                y: 0,
                                maxWidth: f,
                ...
                c = this.intervalStartPosition; c < e; Va(c, b, this.intervalType)) {
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({
                        ...
                        value: new Date(l),
                        label: this.labels[l] ? this.labels[l] : null
                    }) : "axisX" === this.type && this.labels[l] ? this.labels[l] : Aa(l, this.valueFormatString, this.chart._cultureInfo),
                    a = new la(this.ctx,{
                        x: 0,
                        y: 0,
                        maxWidth: f,
            ...
            if ("bottom" === this._position || "top" === this._position)
                ...
                n = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360,
                90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)),
                    ...
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, h = a.text.split(" "), b = 0; b < h.length; b++)
                                    l = h[b],
                        ...
                        for (c = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                a = this._labels[c].textBlock;
                                C = a.measureText();
                                for (h = c + 1; h < this._labels.length; h++)
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                    l = (g - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)),
                                    !s(this.options.labelWrap))
                                        this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, p), l),
                                        this.sessionVariables.labelWrap = this.labelWrap,
                                        C.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                        this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : s(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap,
                                        this.sessionVariables.labelMaxHeight = n,
                                        this.sessionVariables.labelMaxWidth = f,
                                        C.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25,
                                        this.sessionVariables.labelMaxWidth = l)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle,
                                        this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                        this.sessionVariables.labelMaxHeight = n,
                                        this.sessionVariables.labelWrap = this.labelWrap);
                                    else {
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth))
                                                this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                                this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25,
                                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth,
                                                this.sessionVariables.labelMaxHeight = n);
                                            else if (!s(d))
                                                if (b = C.width + d.width >> 0,
                                                h = this.labelFontSize,
                                                p < f)
                                                    b - 2 * f > q && (q = b - 2 * f,
                                                    b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f,
                                                    s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h),
                                                    a.measureText()),
                                                    ...
                                                    this.sessionVariables.labelFontSize = h) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, p),
                                                    this.sessionVariables.labelWrap = !0,
                                                    s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize,
                                                    this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = l,
                                                    this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h),
                                                    a.measureText()),
                                                    this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelMaxWidth = l) : b > 5 * f && (this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelMaxWidth = f,
                                                    this.sessionVariables.labelFontSize = h,
                                                    this.sessionVariables.labelMaxHeight = n,
                                                    this.sessionVariables.labelAngle = this.labelAngle));
                                                else if (v === c && (0 === v && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q || v === this._labels.length - 1 && p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q || 0 < v && v < this._labels.length - 1 && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q && p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q))
                                                    q = 0 === v ? p + this._labels[v + 1].textBlock.measureText().width - 2 * f : p + this._labels[v - 1].textBlock.measureText().width - 2 * f,
                                                    this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    this.sessionVariables.labelAngle = -25,
                                                    this.sessionVariables.labelMaxWidth = l;
                                                else if (0 === q)
                                                    for (this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize,
                                                    this.sessionVariables.labelWrap = !0,
                                                    b = 0; b < this._labels.length; b++)
                                                        a = this._labels[b].textBlock,
                                                        a.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, p), l),
                                                        C = a.measureText(),
                                                        b < this._labels.length - 1 && (h = b + 1,
                                                        d = this._labels[h].textBlock,
                                                        d.maxWidth = this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, p), l),
                                                        d = d.measureText(),
                                                        C.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25))
                                    }
                                else
                                    (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b),
                                    l = 0 != this.labelAngle ? (g - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) : f,
                                    this.sessionVariables.labelMaxHeight = n = this.labelWrap ? (g - l * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) : 1.5 * this.labelFontSize,
                                    ...
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l,
                                    this.sessionVariables.labelMaxHeight = n) : (this.sessionVariables.labelAngle = this.labelAngle,
                                    this.sessionVariables.labelMaxWidth = l,
                                    this.sessionVariables.labelMaxHeight = b < 0.9 * m ? 0.9 * m : b,
                                    this.sessionVariables.labelWrap = this.labelWrap)) : (this.options.labelWrap ? (this.sessionVariables.labelWrap = this.labelWrap,
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l) : (s(this.options.labelMaxWidth),
                                    this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : l,
                                    this.sessionVariables.labelWrap = this.labelWrap),
                                    this.sessionVariables.labelMaxHeight = n)
                            }
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            a = this._labels[c].textBlock,
                            a.maxWidth = this.labelMaxWidth = s(this.options.labelMaxWidth) ? s(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth,
                            ...
                            a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = n : this.sessionVariables.labelMaxHeight,
                            a.measureText();
                else if ("left" === this._position || "right" === this._position)
                    if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth,
                    n = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    !this.chart.panEnabled && 1 <= this._labels.length) {
                        this.sessionVariables.labelFontSize = this.labelFontSize;
                        this.sessionVariables.labelMaxWidth = f;
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                Math.cos(Math.PI / 180 * Math.abs(this.labelAngle));
                                Math.sin(Math.PI / 180 * Math.abs(this.labelAngle));
                                s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle ? s(this.options.labelWrap) ? s(this.options.labelWrap) && (s(this.options.labelMaxWidth) ? s(d) || (m = C.height + d.height >> 0,
                                m - 2 * n > p && (p = m - 2 * n,
                                m >= 2 * n && m < 2.4 * n ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelMaxHeight = n,
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize) : m >= 2.4 * n && m < 2.8 * n ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelFontSize = this.labelFontSize,
                                this.sessionVariables.labelWrap = !0) : m >= 2.8 * n && m < 3.2 * n ? (this.sessionVariables.labelMaxHeight = n,
                                this.sessionVariables.labelWrap = !0,
                                s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : m >= 3.2 * n && m < 3.6 * n ? (this.sessionVariables.labelMaxHeight = b,
                                this.sessionVariables.labelWrap = !0,
                                this.sessionVariables.labelFontSize = this.labelFontSize) : m > 3.6 * n && m < 10 * n ? (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelMaxHeight = n,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle) : m > 10 * n && m < 50 * n && (s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize),
                                a.measureText()),
                                this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? this.labelFontSize : this.options.labelFontSize,
                                this.sessionVariables.labelMaxHeight = n,
                                this.sessionVariables.labelMaxWidth = f,
                                this.sessionVariables.labelAngle = s(this.sessionVariables.labelAngle) ? 0 : this.sessionVariables.labelAngle))) : (this.sessionVariables.labelMaxHeight = n,
                                this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth)) : (this.sessionVariables.labelMaxWidth = this.labelWrap ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : this.labelMaxWidth ? this.options.labelMaxWidth ? this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth : f,
                                this.sessionVariables.labelMaxHeight = n) : (this.sessionVariables.labelAngle = this.labelAngle,
                                this.sessionVariables.labelMaxWidth = 0 === this.labelAngle ? f : Math.min((b - n * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)), n),
                                s(this.options.labelWrap)) ? s(this.options.labelWrap) && (this.labelWrap && !s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth > this.options.labelMaxWidth : this.sessionVariables.labelMaxWidth,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth ? this.options.labelMaxWidth : f,
                                this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : b,
                                s(this.options.labelMaxWidth) && (this.sessionVariables.labelAngle = this.labelAngle))) : this.options.labelWrap ? (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : b,
                                this.sessionVariables.labelWrap = this.labelWrap,
                                this.sessionVariables.labelMaxWidth = f) : (this.sessionVariables.labelMaxHeight = n,
            ...
            for (c = 0; c < this.stripLines.length; c++) {
                ...
                if ("outside" === f.labelPlacement) {
                    ...
                    if ("bottom" === this._position || "top" === this._position)
                        w = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize;
                    if ("left" === this._position || "right" === this._position)
                        w = s(f.options.labelWrap) ? this.sessionVariables.labelMaxHeight : f.labelWrap ? 0.8 * this.chart.width >> 0 : 1.5 * this.labelFontSize;
                    s(f.labelBackgroundColor) && (f.labelBackgroundColor = "#EEEEEE")
                } else
                    n = "bottom" === this._position || "top" === this._position ? 0.9 * this.chart.width >> 0 : 0.9 * this.chart.height >> 0,
                    w = s(f.options.labelWrap) || f.labelWrap ? "bottom" === this._position || "top" === this._position ? 0.8 * this.chart.width >> 0 : 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize,
                    s(f.labelBackgroundColor) && (s(f.startValue) && 0 !== f.startValue ? f.labelBackgroundColor = t ? "transparent" : null : f.labelBackgroundColor = "#EEEEEE");
                a = new la(this.ctx,{
                    x: 0,
                    y: 0,
        ...
        D.prototype.createLabelsAndCalculateWidth = function() {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                for (d = 0; d < this._stripLineLabels.length; d++)
                    "outside" === this._stripLineLabels[d].stripLine.labelPlacement && (this._stripLineLabels[d].stripLine.value >= this.viewportMinimum && this._stripLineLabels[d].stripLine.value <= this.viewportMaximum) && (b = this._stripLineLabels[d].textBlock,
                    e = b.measureText(),
                    f = 0 === this.labelAngle ? e.width : e.width * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - b.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)),
                    a < f && (a = f),
        ...
        D.prototype.createLabelsAndCalculateHeight = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                for (c = 0; c < this._stripLineLabels.length; c++)
                    "outside" === this._stripLineLabels[c].stripLine.labelPlacement && (this._stripLineLabels[c].stripLine.value >= this.viewportMinimum && this._stripLineLabels[c].stripLine.value <= this.viewportMaximum) && (d = this._stripLineLabels[c].textBlock,
                    e = d.measureText(),
                    f = 0 === this.labelAngle ? e.height : e.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (e.height - d.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                    a < f && (a = f),
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            if (a && 0 < a.length)
                for (var h = 0; h < a.length; h++)
                    a[h] && a[h].calculateAxisParameters();
            if (d && 0 < d.length)
                for (h = 0; h < d.length; h++)
                    d[h].calculateAxisParameters();
            if (c && 0 < c.length)
                for (h = 0; h < c.length; h++)
                    c[h].calculateAxisParameters();
            if (b && 0 < b.length)
                for (h = 0; h < b.length; h++)
                    b[h].calculateAxisParameters();
            for (h = 0; h < p.length; h++)
                if (p[h] && p[h].scaleBreaks && p[h].scaleBreaks._appliedBreaks.length)
                    for (var t = p[h].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[h].viewportMaximum); v++)
                        t[v].endValue < p[h].viewportMinimum || (s(p[h].scaleBreaks.firstBreakIndex) && (p[h].scaleBreaks.firstBreakIndex = v),
                        t[v].startValue >= p[h].viewPortMinimum && (p[h].scaleBreaks.lastBreakIndex = v));
            for (var w = v = 0, u = 0, x = 0, z = 0, D = 0, y = 0, B, E, G = m = 0, I, O, M, t = I = O = M = !1, h = 0; h < p.length; h++)
                p[h] && p[h].title && (p[h]._titleTextBlock = new la(p[h].ctx,{
                    text: p[h].title,
                    horizontalAlign: "center",
            ...
            for (h = 0; h < p.length; h++)
                if (p[h].title)
                    ...
                    default:
                        ...
                        p[h]._titleTextBlock.maxHeight = p[h].titleWrap ? 0.8 * f.height : 1.5 * p[h].titleFontSize,
                        p[h]._titleTextBlock.angle = 0
                    }
            if ("normal" === e) {
                for (var x = [], z = [], D = [], y = [], N = [], P = [], R = [], S = []; 4 > v; ) {
                    ...
                    if (c && 0 < c.length)
                        for (D = [],
                        h = Q = 0; h < c.length; h++)
                            D.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)),
                            Q += D[h],
                            K += c[h] && !l.isNavigator ? c[h].margin : 0;
                    else
                    ...
                    if (b && 0 < b.length)
                        for (y = [],
                        h = ba = 0; h < b.length; h++)
                            y.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)),
                            ba += y[h],
                            $ += b[h] ? b[h].margin : 0;
                    else
                    ...
                    if (a && 0 < a.length)
                        ...
                        h = U = 0; h < a.length; h++)
                            ...
                            a[h].lineCoordinates.width = Math.abs(k - n),
                            ...
                            U += x[h],
                            e += a[h] && !l.isNavigator ? a[h].margin : 0;
                    else
                    ...
                    if (d && 0 < d.length)
                        ...
                        h = X = 0; h < d.length; h++)
                            ...
                            d[h].lineCoordinates.width = Math.abs(k - n),
                            ...
                            z.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateHeight() : 0)),
                            X += z[h],
                            Y += d[h] && !l.isNavigator ? d[h].margin : 0;
                    else
                        z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    P.push(z);
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++)
                            a[h] && (a[h].lineCoordinates.x1 = n,
                            k = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $),
                            a[h]._labels && 1 < a[h]._labels.length && (m = g = 0,
                            g = a[h]._labels[1],
                            m = "dateTime" === a[h].valueType ? a[h]._labels[a[h]._labels.length - 2] : a[h]._labels[a[h]._labels.length - 1],
                            w = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)),
                            u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle))),
                            !a[h] || (!a[h].labelAutoFit || s(B) || s(E) || l.isNavigator) || (m = 0,
                            0 < a[h].labelAngle ? E + u > k && (m += 0 < a[h].labelAngle ? E + u - k - ba : 0) : 0 > a[h].labelAngle ? B - w < n && B - w < a[h].viewportMinimum && (G = n - (K + a[h].tickLength + D + B - w + a[h].labelFontSize / 2)) : 0 === a[h].labelAngle && (E + u > k && (m = E + u / 2 - k - ba),
                            B - w < n && B - w < a[h].viewportMinimum && (G = n - K - a[h].tickLength - D - B + w / 2)),
                            a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 < a[h].labelAngle && 0 < m ? k -= m : a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 > a[h].labelAngle && 0 < G ? n += G : a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 === a[h].labelAngle && (0 < G && (n += G),
                            0 < m && (k -= m))),
                            l.panEnabled ? U = s(l.sessionVariables.axisX.height) ? l.sessionVariables.axisX.height = U : l.sessionVariables.axisX.height : l.sessionVariables.axisX.height = U,
                            m = Math.round(f.y2 - U - e + F),
                            g = Math.round(f.y2),
                            a[h].lineCoordinates.x2 = k,
                            a[h].lineCoordinates.width = k - n,
                            a[h].lineCoordinates.y1 = m,
                            a[h].lineCoordinates.y2 = m,
                            a[h].bounds = {
                                x1: n,
                                y1: m,
                                x2: k,
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++)
                            d[h].lineCoordinates.x1 = Math.round(f.x1 + Q + K),
                            d[h].lineCoordinates.x2 = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $),
                            d[h].lineCoordinates.width = Math.abs(k - n),
                            d[h]._labels && 1 < d[h]._labels.length && (g = d[h]._labels[1],
                            m = "dateTime" === d[h].valueType ? d[h]._labels[d[h]._labels.length - 2] : d[h]._labels[d[h]._labels.length - 1],
                            w = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)),
                            u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle))),
                            l.panEnabled ? X = s(l.sessionVariables.axisX2.height) ? l.sessionVariables.axisX2.height = X : l.sessionVariables.axisX2.height : l.sessionVariables.axisX2.height = X,
                            m = Math.round(f.y1),
                            g = Math.round(f.y2 + d[h].margin),
                            d[h].lineCoordinates.y1 = m + X + Y - V,
                            d[h].lineCoordinates.y2 = m,
                            d[h].bounds = {
                                x1: n,
                                y1: m + (X + Y - z[h] - V),
                                x2: k,
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++)
                            ...
                            c[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                            K = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : q,
                            m = Math.round(f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y),
                            k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                            K = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : q,
                            g = Math.round(f.y2 - U - e - K),
                            c[h].lineCoordinates = {
                                x1: k - T,
                                y1: m,
                                x2: k - T,
                    ...
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++)
                            b[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                            k = Math.round(n),
                            K = b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[b[h]._labels.length - 1].textBlock.height / 2 : 0,
                            m = Math.round(f.y1 + X + Y < Math.max(K, q) ? Math.max(K, q) : f.y1 + X + Y),
                            K = 0 < a.length ? 0 : b[h]._labels && 0 < b[h]._labels.length ? b[h]._labels[0].textBlock.height / 2 : 0,
                            g = Math.round(f.y2 - (U + e + K)),
                            b[h].lineCoordinates = {
                                x1: n + W,
                                y1: m,
                    ...
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++)
                            a[h] && (a[h].calculateValueToPixelConversionParameters(),
                            a[h].calculateBreaksSizeInValues(),
                            a[h]._labels && 1 < a[h]._labels.length && (B = (a[h].logarithmic ? Math.log(a[h]._labels[1].position / a[h].viewportMinimum) / a[h].conversionParameters.lnLogarithmBase : a[h]._labels[1].position - a[h].viewportMinimum) * Math.abs(a[h].conversionParameters.pixelPerUnit) + a[h].lineCoordinates.x1,
                            n = a[h]._labels[a[h]._labels.length - ("dateTime" === a[h].valueType ? 2 : 1)].position,
                            n = a[h].getApparentDifference(a[h].viewportMinimum, n),
                            E = a[h].logarithmic ? (1 < n ? Math.log(n) / a[h].conversionParameters.lnLogarithmBase * Math.abs(a[h].conversionParameters.pixelPerUnit) : 0) + a[h].lineCoordinates.x1 : (0 < n ? n * Math.abs(a[h].conversionParameters.pixelPerUnit) : 0) + a[h].lineCoordinates.x1));
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++)
                            d[h].calculateValueToPixelConversionParameters(),
                            d[h].calculateBreaksSizeInValues(),
                            d[h]._labels && 1 < d[h]._labels.length && (B = (d[h].logarithmic ? Math.log(d[h]._labels[1].position / d[h].viewportMinimum) / d[h].conversionParameters.lnLogarithmBase : d[h]._labels[1].position - d[h].viewportMinimum) * Math.abs(d[h].conversionParameters.pixelPerUnit) + d[h].lineCoordinates.x1,
                            n = d[h]._labels[d[h]._labels.length - ("dateTime" === d[h].valueType ? 2 : 1)].position,
                            n = d[h].getApparentDifference(d[h].viewportMinimum, n),
                            E = d[h].logarithmic ? (1 < n ? Math.log(n) / d[h].conversionParameters.lnLogarithmBase * Math.abs(d[h].conversionParameters.pixelPerUnit) : 0) + d[h].lineCoordinates.x1 : (0 < n ? n * Math.abs(d[h].conversionParameters.pixelPerUnit) : 0) + d[h].lineCoordinates.x1);
                    for (h = 0; h < p.length; h++)
                        "axisY" === p[h].type && (p[h].calculateValueToPixelConversionParameters(),
                        p[h].calculateBreaksSizeInValues());
                    if (0 < v) {
                        if (a && 0 < a.length)
                            for (h = 0; h < a.length; h++)
                                t = N[v - 1][h] === N[v][h] ? !0 : !1;
                ...
                if (a && 0 < a.length)
                    for (h = 0; h < a.length; h++)
                        a[h].calculateStripLinesThicknessInValues(),
                        a[h].calculateBreaksInPixels();
                if (d && 0 < d.length)
                    for (h = 0; h < d.length; h++)
                        d[h].calculateStripLinesThicknessInValues(),
                        d[h].calculateBreaksInPixels();
                if (c && 0 < c.length)
                    for (h = 0; h < c.length; h++)
                        c[h].calculateStripLinesThicknessInValues(),
                        c[h].calculateBreaksInPixels();
                if (b && 0 < b.length)
                    for (h = 0; h < b.length; h++)
                        b[h].calculateStripLinesThicknessInValues(),
                ...
                for (P = []; 4 > v; ) {
                    ...
                    if (a && 0 < a.length)
                        for (G = [],
                        h = W = 0; h < a.length; h++)
                            G.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)),
                            W += G[h],
                            e += a[h] && !l.isNavigator ? a[h].margin : 0;
                    else
                    ...
                    if (d && 0 < d.length)
                        for (w = [],
                        h = U = 0; h < d.length; h++)
                            w.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)),
                            U += w[h],
                            Y += d[h] ? d[h].margin : 0;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++)
                            ...
                            k = Math.round(f.x2 - U - Y > l.width - 10 ? l.width - 10 : f.x2 - U - Y),
                            c[h].labelAutoFit && !s(x) && (0 < !a.length && (n = 0 > c[h].labelAngle ? Math.max(n, x) : 0 === c[h].labelAngle ? Math.max(n, x / 2) : n),
                            0 < !d.length && (k = 0 < c[h].labelAngle ? k - z / 2 : 0 === c[h].labelAngle ? k - z / 2 : k)),
                            c[h].lineCoordinates.x1 = n,
                            c[h].lineCoordinates.x2 = k,
                            c[h].lineCoordinates.width = Math.abs(k - n),
                    ...
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++)
                            b[h].lineCoordinates = {},
                            n = Math.round(f.x1 + W + e),
                            k = Math.round(f.x2 - U - Y > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - U - Y),
                            b[h] && b[h].labelAutoFit && !s(D) && (0 < !a.length && (n = 0 < b[h].labelAngle ? Math.max(n, D) : 0 === b[h].labelAngle ? Math.max(n, D / 2) : n),
                            0 < !d.length && (k -= y / 2)),
                            b[h].lineCoordinates.x1 = n,
                            b[h].lineCoordinates.x2 = k,
                            b[h].lineCoordinates.width = Math.abs(k - n),
                    ...
                    if (c && 0 < c.length)
                        for (q = [],
                        h = T = 0; h < c.length; h++)
                            q.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)),
                            T += q[h] + c[h].margin,
                            K += c[h].margin;
                    else
                    ...
                    if (b && 0 < b.length)
                        for (B = [],
                        h = V = 0; h < b.length; h++)
                            B.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)),
                            V += B[h],
                            $ += b[h].margin;
                    else
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++)
                            0 < c[h]._labels.length && (g = c[h]._labels[0],
                            m = c[h]._labels[c[h]._labels.length - 1],
                            x = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)),
                            z = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    if (b && 0 < b.length)
                        for (h = 0; h < b.length; h++)
                            b[h] && 0 < b[h]._labels.length && (g = b[h]._labels[0],
                            m = b[h]._labels[b[h]._labels.length - 1],
                            D = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)),
                            y = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle)));
                    if (l.panEnabled)
                        for (h = 0; h < c.length; h++)
                            q[h] = s(l.sessionVariables.axisY.height) ? l.sessionVariables.axisY.height = q[h] : l.sessionVariables.axisY.height;
                    else
                        for (h = 0; h < c.length; h++)
                            l.sessionVariables.axisY.height = q[h];
                    if (c && 0 < c.length)
                        for (h = c.length - 1; 0 <= h; h--)
                            m = Math.round(f.y2),
                            g = Math.round(f.y2 > c[h].chart.height - 10 ? c[h].chart.height - 10 : f.y2),
                            c[h].lineCoordinates.y1 = m - (q[h] + c[h].margin + X),
                            c[h].lineCoordinates.y2 = m - (q[h] + c[h].margin + X),
                            c[h].bounds = {
                                x1: n,
                    ...
                    if (b && 0 < b.length)
                        for (h = b.length - 1; 0 <= h; h--)
                            b[h] && (m = Math.round(f.y1),
                            g = Math.round(f.y1 + (B[h] + b[h].margin + F)),
                            b[h].lineCoordinates.y1 = g,
                            b[h].lineCoordinates.y2 = g,
                            b[h].bounds = {
                                x1: n,
                                y1: m + (b[h].margin + F),
                                x2: k,
                        ...
                        for (h = 0; h < a.length; h++) {
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k,
                                    n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : n);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1,
                                    n = k - W);
                            a[h].lineCoordinates = {
                                x1: k - R,
                                y1: m,
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) {
                            K = d[h]._labels && 0 < d[h]._labels.length ? d[h]._labels[0].textBlock.fontSize / 2 : 0;
                            n = Math.round(f.x1 - e);
                            m = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y2 : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1) : f.y1 < Math.max(K, 10) ? Math.max(K, 10) : f.y1;
                            ...
                            if (c && 0 < c.length)
                                for (K = 0; K < c.length; K++)
                                    c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k,
                                    n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : n);
                            if (b && 0 < b.length)
                                for (K = 0; K < b.length; K++)
                                    b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2,
                                    n = k - U);
                            d[h].lineCoordinates = {
                                x1: k + S,
                                y1: m,
        ...
        D.render = function(a, d, c, b, e) {
            ...
            if (a && 0 < a.length)
                for (m = 0; m < a.length; m++)
                    a[m].renderGrid(),
                    t && (a[m].createMask(),
                    a[m].renderBreaksBackground());
            if (d && 0 < d.length)
                for (m = 0; m < d.length; m++)
                    d[m].renderGrid(),
                    t && (d[m].createMask(),
                    d[m].renderBreaksBackground());
            if (c && 0 < c.length)
                for (m = 0; m < c.length; m++)
                    c[m].renderGrid(),
                    t && (c[m].createMask(),
                    c[m].renderBreaksBackground());
            if (b && 0 < b.length)
                for (m = 0; m < b.length; m++)
                    b[m].renderGrid(),
                    t && (b[m].createMask(),
                    b[m].renderBreaksBackground());
            if (a && 0 < a.length)
                for (m = 0; m < a.length; m++)
                    a[m].renderAxisLine();
            if (d && 0 < d.length)
        ...
        D.prototype.calculateBreaksInPixels = function() {
            if (!(this.scaleBreaks && 0 >= this.scaleBreaks._appliedBreaks.length)) {
                ...
                for (var d = 0; d < a.length && !(a[d].startValue > this.conversionParameters.maximum); d++)
                    a[d].endValue < this.conversionParameters.minimum || (s(this.scaleBreaks.firstBreakIndex) && (this.scaleBreaks.firstBreakIndex = d),
        ...
        D.prototype.renderLabelsTicksAndTitle = function() {
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, k, m = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), g = this._labels.length - 1; 0 <= g; g--) {
                            ...
                            if (q.position < this.viewportMinimum)
                                break;
                            q.position > this.viewportMaximum || !(g === this._labels.length - 1 || k < Math.log(m / q.position) * l / e) || (c.push(q),
                            m = q.position,
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], r, m = this.viewportMaximum, l = this.lineCoordinates.height / Math.log(this.range), g = this._labels.length - 1; 0 <= g; g--) {
                            ...
                            if (q.position < this.viewportMinimum)
                                break;
                            q.position > this.viewportMaximum || !(g === this._labels.length - 1 || r < Math.log(m / q.position) * l) || (c.push(q),
                            m = q.position,
                            r = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
                        for (g = 0; g < this._labels.length; g++)
                            q = this._labels[g],
                            q.position < this.viewportMinimum || (r = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)),
                            b += r);
            ...
            if ("bottom" === this._position) {
                for (g = 0; g < this._labels.length; g++)
                    q = this._labels[g],
                    q.position < this.viewportMinimum || q.position > this.viewportMaximum || (p = this.getPixelCoordinatesOnAxis(q.position),
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === q.textBlock.angle ? (p.x -= q.textBlock.width / 2,
                    p.y = "inside" === this.labelPlacement ? p.y - (("inside" === this.tickPlacement ? this.tickLength : 0) + q.textBlock.height - q.textBlock.fontSize / 2) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + q.textBlock.fontSize / 2 + 5) : (p.x = "inside" === this.labelPlacement ? 0 > this.labelAngle ? p.x : p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : p.x - (0 > this.labelAngle ? q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                    p.y = "inside" === this.labelPlacement ? 0 > this.labelAngle ? p.y - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : p.y - ("inside" === this.tickPlacement ? 0 : this.tickLength) - Math.abs(q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + 5) : p.y + ("inside" === this.tickPlacement ? 0 : this.tickLength) + Math.abs(0 > this.labelAngle ? q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5)),
                    q.textBlock.x = p.x,
                    q.textBlock.y = p.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (g = 0; g < a._labels.length; g++)
                        if (q = a._labels[g],
                        !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position),
                        a.tickThickness)) {
                ...
                for (g = 0; g < this._labels.length; g++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === q.textBlock.angle ? (p.x -= q.textBlock.width / 2,
                    p.y = "inside" === this.labelPlacement ? p.y + this.labelFontSize / 2 + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + q.textBlock.height - q.textBlock.fontSize / 2)) : (p.x = "inside" === this.labelPlacement ? 0 < this.labelAngle ? p.x : p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : p.x + (q.textBlock.height - this.labelFontSize) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                    p.y = "inside" === this.labelPlacement ? 0 < this.labelAngle ? p.y + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.y - q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.y - (("inside" === this.tickPlacement ? 0 : this.tickLength) + ((q.textBlock.height - q.textBlock.fontSize / 2) * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))),
                    q.textBlock.x = p.x,
                    q.textBlock.y = p.y));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (g = 0; g < a._labels.length; g++)
                ...
                for (g = 0; g < this._labels.length; g++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (q.textBlock.y = p.y,
                    q.textBlock.x = "inside" === this.labelPlacement ? p.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5) : (q.textBlock.y = "inside" === this.labelPlacement ? p.y : p.y - q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                    q.textBlock.x = "inside" === this.labelPlacement ? p.x + ("inside" === this.tickPlacement ? this.tickLength : 0) + 5 : 0 < this.labelAngle ? p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength) - 5 : p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? 0 : this.tickLength))));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (g = 0; g < a._labels.length; g++)
                        if (q = a._labels[g],
                        !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position),
                ...
                for (g = 0; g < this._labels.length; g++)
                    ...
                    this.ctx.stroke()),
                    d && 0 !== f++ % 2 && this.labelAutoFit || (0 === this.labelAngle ? (q.textBlock.y = p.y,
                    q.textBlock.x = "inside" === this.labelPlacement ? p.x - q.textBlock.width - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : p.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5) : (q.textBlock.y = "inside" === this.labelPlacement ? p.y - q.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0 > this.labelAngle ? p.y : p.y - (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                    q.textBlock.x = "inside" === this.labelPlacement ? p.x - q.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - ("inside" === this.tickPlacement ? this.tickLength : 0) - 5 : 0 < this.labelAngle ? p.x + (q.textBlock.height - q.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + ("inside" === this.tickPlacement ? 0 : this.tickLength) : p.x + ("inside" === this.tickPlacement ? 0 : this.tickLength) + 5)));
                "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                    for (g = 0; g < a._labels.length; g++)
                        if (q = a._labels[g],
                        !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position),
            ...
            if ("inside" === this.labelPlacement)
                this.chart.addEventListener("dataAnimationEnd", function() {
                    for (g = 0; g < a._labels.length; g++)
                        q = a._labels[g],
                        q.position < a.viewportMinimum || (q.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(),
                        a.ctx.beginPath(),
        ...
        D.prototype.renderInterlacedColors = function() {
            ...
            if (("bottom" === this._position || "top" === this._position) && this.interlacedColor)
                ...
                for (a.fillStyle = this.interlacedColor,
                e = 0; e < this._labels.length; e++)
                    d ? (c = this.getPixelCoordinatesOnAxis(this._labels[e].position),
        ...
        D.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                for (b = 0; b < this._stripLineLabels.length; b++)
                    if (g = this.stripLines[b],
                    c = this._stripLineLabels[b],
                    !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                        a = this.getPixelCoordinatesOnAxis(c.position);
                        if ("outside" === c.stripLine.labelPlacement)
                            if (g && (this.ctx.strokeStyle = g.color,
                            "pixel" === g._thicknessType && (this.ctx.lineWidth = g.thickness)),
                            "bottom" === this._position) {
                                ...
                                this.ctx.stroke();
                                0 === this.labelAngle ? (a.x -= c.textBlock.width / 2,
                                a.y += this.tickLength + c.textBlock.fontSize / 2) : (a.x -= 0 > this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0,
                                a.y += this.tickLength + Math.abs(0 > this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) - 5 : 5))
                            } else
                                "top" === this._position ? (r = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0,
                                this.ctx.beginPath(),
                                this.ctx.moveTo(r, a.y << 0),
                                this.ctx.lineTo(r, a.y - this.tickLength << 0),
                                this.ctx.stroke(),
                                0 === this.labelAngle ? (a.x -= c.textBlock.width / 2,
                                a.y -= this.tickLength + c.textBlock.height) : (a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0),
                                a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) + (0 < this.labelAngle ? c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle) : 0)))) : "left" === this._position ? (r = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
                                this.ctx.beginPath(),
                                this.ctx.moveTo(a.x << 0, r),
                                this.ctx.lineTo(a.x - this.tickLength << 0, r),
                                this.ctx.stroke(),
                                0 === this.labelAngle ? a.x = a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : (a.y -= c.textBlock.width * Math.sin(Math.PI / 180 * this.labelAngle),
                                a.x = 0 < this.labelAngle ? a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5 : a.x - c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) - this.tickLength)) : "right" === this._position && (r = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0,
                                this.ctx.beginPath(),
                                this.ctx.moveTo(a.x << 0, r),
                                this.ctx.lineTo(a.x + this.tickLength << 0, r),
                                this.ctx.stroke(),
                                0 === this.labelAngle ? a.x = a.x + this.tickLength + 5 : (a.y = 0 > this.labelAngle ? a.y : a.y - (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.cos(Math.PI / 180 * this.labelAngle),
                            ...
                            a.x - c.textBlock.height > this.chart.plotArea.x1 ? s(g.startValue) ? a.x -= c.textBlock.height - c.textBlock.fontSize / 2 : a.x -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3 : (c.textBlock.angle = 90,
                            s(g.startValue) ? a.x += c.textBlock.height - c.textBlock.fontSize / 2 : a.x += c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3),
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - c.textBlock.height > this.chart.plotArea.y1 ? s(g.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : s(g.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize + 3,
                            ...
                            c.textBlock.angle = 0,
                            c.textBlock.measureText(),
                            a.y - +c.textBlock.height > this.chart.plotArea.y1 ? s(g.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 - 3 : a.y - c.textBlock.height < this.chart.plotArea.y2 ? a.y += c.textBlock.fontSize / 2 + 3 : s(g.startValue) ? a.y -= c.textBlock.height - c.textBlock.fontSize / 2 : a.y -= c.textBlock.height / 2 - c.textBlock.fontSize / 2 + 3,
                    ...
                    for (b = 0; b < m.length; b++)
                        ...
                        this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            ...
                            for (e = 0; e < m.length; e++)
                                g = m[e],
                                g.showOnTop && g.render();
                            this.ctx.restore()
                        }, g)) : g.render();
                    for (b = 0; b < l.length; b++)
                        c = l[b],
                        c.stripLine.showOnTop ? k || (k = !0,
                        this.chart.addEventListener("dataAnimationIterationEnd", function() {
                            for (e = 0; e < l.length; e++)
                                c = l[e],
                                "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(),
                                d.ctx.beginPath(),
        ...
        D.prototype.createMask = function() {
            if (this.scaleBreaks && 0 < this.scaleBreaks._appliedBreaks.length) {
                ...
                t ? (this.maskCanvas = ta(this.chart.width, this.chart.height),
        ...
        D.prototype.renderGrid = function() {
            if (this.gridThickness && 0 < this.gridThickness) {
                ...
                if ("bottom" === this._position || "top" === this._position)
                    for (b = 0; b < this._labels.length; b++)
                        this._labels[b].position < this.viewportMinimum || (this._labels[b].position > this.viewportMaximum || this._labels[b].breaksLabelType) || (a.beginPath(),
        ...
        D.prototype.renderAxisLine = function() {
            var a = this.chart.ctx, d = t ? this.chart._preRenderCtx : a, c = Math.ceil(this.tickThickness / (this.reversed ? -2 : 2)), b = Math.ceil(this.tickThickness / (this.reversed ? 2 : -2)), e, f;
            d.save();
            if ("bottom" === this._position || "top" === this._position) {
                if (this.lineThickness) {
                    this.reversed ? (e = this.lineCoordinates.x2,
                    f = this.lineCoordinates.x1) : (e = this.lineCoordinates.x1,
                    f = this.lineCoordinates.x2);
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex))
                            ...
                            for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++)
                                d.moveTo(e, k),
                                d.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel + c, k),
                ...
                f = this.lineCoordinates.y2) : (e = this.lineCoordinates.y2,
                ...
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                    if (s(this.scaleBreaks.lastBreakIndex))
                        ...
                        for (m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++)
                            d.moveTo(k, e),
            ...
            t && (a.drawImage(this.chart._preRenderCanvas, 0, 0, this.chart.width, this.chart.height),
        ...
        D.prototype.convertPixelToValue = function(a) {
            if ("undefined" === typeof a)
                return null;
            var d = 0, c = 0, b, d = !0, e = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x;
            if (this.logarithmic) {
        ...
        D.prototype.getApparentDifference = function(a, d, c, b) {
            ...
            if (this.logarithmic) {
                ...
                for (c = s(c) ? Math.abs(d - a) : c,
                f = 0; f < e.length && !(d < e[f].startValue); f++)
        ...
        D.prototype.calculateValueToPixelConversionParameters = function(a) {
            ...
            if (this.logarithmic)
                for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++)
                    this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue,
                    c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * this.viewportMinimum,
                    c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (b = b / this.viewportMaximum * a[e].startValue,
                    c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
            else
                for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++)
                    ...
                    c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)));
        ...
        D.prototype.calculateAxisParameters = function() {
            if (this.logarithmic)
                ...
                if ("axisX" === this.type) {
                    ...
                    0 === f - e && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval,
                    f += b,
                    e -= b);
                    Infinity !== this.dataInfo.minDiff ? k = this.dataInfo.minDiff : 1 < f - e ? k = 0.5 * Math.abs(f - e) : (k = 1,
                    c && (d = !0))
                } else
                    "axisY" === this.type && (e = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
                    f = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
                    isFinite(e) || isFinite(f) ? isFinite(e) ? isFinite(f) || (f = e) : e = f : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                    e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                    0 === e && 0 === f ? (f += 9,
                    e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5),
                    f += b,
                    e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5),
                    0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05),
                    0 !== f && (f += b),
                    0 !== e && (e -= b)),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1,
                ...
                if ("axisX" === this.type && c) {
                    this.intervalType || (b / 1 <= a ? (this.interval = 1,
                    this.intervalType = "millisecond") : b / 2 <= a ? (this.interval = 2,
                    this.intervalType = "millisecond") : b / 5 <= a ? (this.interval = 5,
                    this.intervalType = "millisecond") : b / 10 <= a ? (this.interval = 10,
                    this.intervalType = "millisecond") : b / 20 <= a ? (this.interval = 20,
                    this.intervalType = "millisecond") : b / 50 <= a ? (this.interval = 50,
                    this.intervalType = "millisecond") : b / 100 <= a ? (this.interval = 100,
                    this.intervalType = "millisecond") : b / 200 <= a ? (this.interval = 200,
                    this.intervalType = "millisecond") : b / 250 <= a ? (this.interval = 250,
                    this.intervalType = "millisecond") : b / 300 <= a ? (this.interval = 300,
                    this.intervalType = "millisecond") : b / 400 <= a ? (this.interval = 400,
                    this.intervalType = "millisecond") : b / 500 <= a ? (this.interval = 500,
                    this.intervalType = "millisecond") : b / (1 * S.secondDuration) <= a ? (this.interval = 1,
                    this.intervalType = "second") : b / (2 * S.secondDuration) <= a ? (this.interval = 2,
                    this.intervalType = "second") : b / (5 * S.secondDuration) <= a ? (this.interval = 5,
                    this.intervalType = "second") : b / (10 * S.secondDuration) <= a ? (this.interval = 10,
                    this.intervalType = "second") : b / (15 * S.secondDuration) <= a ? (this.interval = 15,
                    this.intervalType = "second") : b / (20 * S.secondDuration) <= a ? (this.interval = 20,
                    this.intervalType = "second") : b / (30 * S.secondDuration) <= a ? (this.interval = 30,
                    this.intervalType = "second") : b / (1 * S.minuteDuration) <= a ? (this.interval = 1,
                    this.intervalType = "minute") : b / (2 * S.minuteDuration) <= a ? (this.interval = 2,
                    this.intervalType = "minute") : b / (5 * S.minuteDuration) <= a ? (this.interval = 5,
                    this.intervalType = "minute") : b / (10 * S.minuteDuration) <= a ? (this.interval = 10,
                    this.intervalType = "minute") : b / (15 * S.minuteDuration) <= a ? (this.interval = 15,
                    this.intervalType = "minute") : b / (20 * S.minuteDuration) <= a ? (this.interval = 20,
                    this.intervalType = "minute") : b / (30 * S.minuteDuration) <= a ? (this.interval = 30,
                    this.intervalType = "minute") : b / (1 * S.hourDuration) <= a ? (this.interval = 1,
                    this.intervalType = "hour") : b / (2 * S.hourDuration) <= a ? (this.interval = 2,
                    this.intervalType = "hour") : b / (3 * S.hourDuration) <= a ? (this.interval = 3,
                    this.intervalType = "hour") : b / (6 * S.hourDuration) <= a ? (this.interval = 6,
                    this.intervalType = "hour") : b / (1 * S.dayDuration) <= a ? (this.interval = 1,
                    this.intervalType = "day") : b / (2 * S.dayDuration) <= a ? (this.interval = 2,
                    this.intervalType = "day") : b / (4 * S.dayDuration) <= a ? (this.interval = 4,
                    this.intervalType = "day") : b / (1 * S.weekDuration) <= a ? (this.interval = 1,
                    this.intervalType = "week") : b / (2 * S.weekDuration) <= a ? (this.interval = 2,
                    this.intervalType = "week") : b / (3 * S.weekDuration) <= a ? (this.interval = 3,
                    this.intervalType = "week") : b / (1 * S.monthDuration) <= a ? (this.interval = 1,
                    this.intervalType = "month") : b / (2 * S.monthDuration) <= a ? (this.interval = 2,
                    this.intervalType = "month") : b / (3 * S.monthDuration) <= a ? (this.interval = 3,
                    this.intervalType = "month") : b / (6 * S.monthDuration) <= a ? (this.interval = 6,
                    this.intervalType = "month") : (this.interval = b / (1 * S.yearDuration) <= a ? 1 : b / (2 * S.yearDuration) <= a ? 2 : b / (4 * S.yearDuration) <= a ? 4 : Math.floor(D.getNiceNumber(b / (a - 1), !0) / S.yearDuration),
                    ...
                    if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
                        this.viewportMaximum = "axisX" === this.type ? f + k / 2 : Math.ceil(f / this.interval) * this.interval;
                ...
                if (null === this.minimum || null === this.maximum)
                    ...
                    f += b,
                    e -= b),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min,
                    f = null !== this.maximum ? this.maximum : this.dataInfo.max,
                    isFinite(e) || isFinite(f) ? 0 === e && 0 === f ? (f += 9,
                    e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5),
                    f += b,
                    e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5),
                    0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05),
                    0 !== f && (f += b),
                    0 !== e && (e -= b)) : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval,
                    e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity),
                    k = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1,
                    ...
                    "axisX" === this.type && c) {
                        ...
                        null === this.maximum && (this.maximum = "axisX" === this.type ? f + k / 2 : Math.ceil(f / this.interval) * this.interval,
        ...
        D.prototype.calculateLogarithmicAxisParameters = function() {
            ...
            this.maxHeight = a.height) : (this.maxWidth = a.height,
            this.maxHeight = a.width);
            var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth / 100)) : Math.max(Math.floor(this.maxWidth / 50), 3), b, e, f, k;
            k = 1;
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
                this.viewportMinimum = this.minimum;
            if (null === this.viewportMaximum || isNaN(this.viewportMaximum))
            ...
            1 === e / b && (k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
            e *= k,
            b /= k),
            f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.viewportMinimum ? this.viewportMinimum : this.dataInfo.viewPortMin,
            e = null !== this.viewportMaximum ? this.viewportMaximum : this.dataInfo.viewPortMax,
            0 >= b && !isFinite(e) ? (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
            b = 1) : 0 >= b ? b = e : isFinite(e) || (e = b),
            1 === b && 1 === e ? (e *= this.logarithmBase - 1 / this.logarithmBase,
            b = 1) : 1 === e / b ? (k = Math.min(e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            e *= k,
            b /= k) : b > e ? (k = Math.min(b / e * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 5)),
            1 <= e ? b = e / k : e = b * k) : (k = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
            1 !== e && (e *= k),
            1 !== b && (b /= k)),
            ...
            this.options && 0 < this.options.interval ? this.interval = this.options.interval : (this.interval = D.getNiceExponent(Math.log(k) / d / (a - 1), !0),
            c = D.getNiceNumber(m / (a - 1), !0));
            if (null === this.viewportMinimum || isNaN(this.viewportMinimum))
            ...
            this.options && "undefined" === typeof this.options.interval && (this.interval = D.getNiceExponent(Math.ceil(Math.log(k) / d) / (a - 1)),
            c = D.getNiceNumber((this.viewportMaximum - this.viewportMinimum) / (a - 1), !0)));
            if (null === this.minimum || null === this.maximum)
                "axisX" === this.type ? (b = null !== this.minimum ? this.minimum : this.dataInfo.min,
                e = null !== this.maximum ? this.maximum : this.dataInfo.max,
                1 === e / b && (k = Math.pow(this.logarithmBase, "undefined" === typeof this.options.interval ? 0.4 : this.options.interval),
                e *= k,
                b /= k),
                f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase) : "axisY" === this.type && (b = null !== this.minimum ? this.minimum : this.dataInfo.min,
                e = null !== this.maximum ? this.maximum : this.dataInfo.max,
                isFinite(b) || isFinite(e) ? 1 === b && 1 === e ? (e *= this.logarithmBase,
                b /= this.logarithmBase) : 1 === e / b ? (k = Math.pow(this.logarithmBase, this.interval),
                e *= k,
                b /= k) : b > e ? (k = Math.min(0.01 * (b / e), 5),
                1 <= e ? b = e / k : e = b * k) : (k = Math.min(e / b * Math.pow(this.logarithmBase, 0.01), Math.pow(this.logarithmBase, 0.04)),
                1 !== e && (e *= k),
                1 !== b && (b /= k)) : (e = "undefined" === typeof this.options.interval ? 0 : this.options.interval,
                b = 1),
                f = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : e / b > this.logarithmBase ? e / b * Math.pow(this.logarithmBase, 0.5) : this.logarithmBase,
                ...
                this.intervalType = "number",
                null === this.minimum && (this.minimum = "axisX" === this.type ? b / Math.sqrt(f) : Math.pow(this.logarithmBase, this.interval * Math.floor(Math.log(b) / d / this.interval)),
            ...
            if (!this.options.interval && this.range < Math.pow(this.logarithmBase, 8 > this.viewportMaximum || 3 > a ? 2 : 3)) {
                ...
                this.options.interval || (c = Math.ceil(this.interval),
                this.range > this.interval && (this.interval = c,
                b = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))),
        ...
        D.generateValueFormatString = function(a, d) {
            var c = "#,##0."
              , b = d;
            1 > a && (b += Math.floor(Math.abs(Math.log(a) / Math.LN10)),
            isNaN(b) || !isFinite(b)) && (b = d);
            for (var e = 0; e < b; e++)
                c += "#";
            return c
        }
        ...
        U.prototype.createUserOptions = function(a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                ...
                this.options._isPlaceholder || (Ca(this.parent[this.optionsName]),
        ...
        U.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0,
                    k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0,
                    "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                    m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2,
                    ...
                    "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a)
                        ...
                        r = (m - g) / a / 3;
                        for (var p = 0; p < r; p++)
                            this.ctx.bezierCurveTo(l + f * a, g + a, l + f * a, g + 2 * a, l, g + 3 * a),
                            g += 3 * a,
                            f *= -1;
                        this.ctx.bezierCurveTo(l + f * a, g + a, l + f * a, g + 2 * a, l, g + 3 * a);
                        l = k;
                    ...
                    "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1,
                    k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2,
        ...
        M.prototype.createUserOptions = function(a) {
            if ("undefined" !== typeof a || this.options._isPlaceholder) {
                var d = 0;
                this.parent.options._isPlaceholder && this.parent.createUserOptions();
                this.options._isPlaceholder || (Ca(this.parent.stripLines),
        ...
        ba.prototype.showAt = function(a) {
            ...
            for (b = 0; b < d.axisX.length; b++)
                ...
                d.axisX[b].crosshair && (d.axisX[b].crosshair.enabled && !s(a) && a >= d.axisX[b].viewportMinimum && a <= d.axisX[b].viewportMaximum) && (d.axisX[b].showCrosshair(a),
                d.axisX[b].crosshair._updatedValue = a,
                this === d.axisX[b].crosshair && (c = !0));
            for (b = 0; b < d.axisX2.length; b++)
                a = d.axisX2[b]._crosshairValue,
                d.axisX2[b].crosshair && (d.axisX2[b].crosshair.enabled && !s(a) && a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum) && (d.axisX2[b].showCrosshair(a),
                d.axisX2[b].crosshair._updatedValue = a,
                this === d.axisX2[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY.length; b++)
                a = d.axisY[b]._crosshairValue,
                d.axisY[b].crosshair && (d.axisY[b].crosshair.enabled && !s(a) && a >= d.axisY[b].viewportMinimum && a <= d.axisY[b].viewportMaximum) && (d.axisY[b].showCrosshair(a),
                d.axisY[b].crosshair._updatedValue = a,
                this === d.axisY[b].crosshair && (c = !0));
            for (b = 0; b < d.axisY2.length; b++)
                a = d.axisY2[b]._crosshairValue,
                d.axisY2[b].crosshair && (d.axisY2[b].crosshair.enabled && !s(a) && d._crosshairY2Value >= d.axisY2[b].viewportMinimum && d._crosshairY2Value <= d.axisY2[b].viewportMaximum) && (d.axisY2[b].showCrosshair(a),
        ...
        ba.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var v = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position)
                        t = this.parent.dataSeries[0].axisX.convertPixelToValue({
                            y: d
                        });
                    else if ("left" === this.parent._position || "right" === this.parent._position)
                    ...
                    for (var w = 0; w < this.parent.dataSeries.length; w++)
                        (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w],
                    ...
                    if ("rangeBar" === r[0].dataSeries.type || "error" === r[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])), u = 0, t = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (var x = 0; x < r[t].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                    u < v && (v = u,
                                    w = t);
                            else
                                u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)),
                                u < v && (v = u,
                                w = t);
                    else if ("stackedBar" === r[0].dataSeries.type)
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), z = u = 0, t = w = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                        ...
                        for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), E = z = u = 0, t = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                    u < v && (v = u,
                                ...
                                z += r[t].dataPoint.y,
                                E = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x,
                                E = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[E]),
                                u = Math.abs(a - this.parent.convertValueToPixel(E)),
                                u < v && (v = u,
                                w = t);
                    else
                        for (v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)),
                        t = w = u = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++)
                                    u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                    u < v && (v = u,
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
                            ...
                            for (t = u = 0; t < x.dataPoint.y.length; t++)
                                u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[t])),
                                u < v && (v = u,
                                b = t);
                            ...
                            g.text = this.labelFormatter ? this.labelFormatter({
                                ...
                                crosshair: this.options,
                                value: c ? c : E
                            }) : s(this.options.label) ? fa(c ? c : E, this.valueFormatString, this.chart._cultureInfo) : this.label
                        } else
                            m = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
                            g.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                        ...
                        if (this.parent.labels)
                            for (r = Math.ceil(this.parent.interval),
                            t = 0; t < this.parent.viewportMaximum; t += r)
                                if (this.parent.labels[t])
                                    E = !0;
                                else {
                                    E = !1;
                                    break
                        ...
                        if (E) {
                            if ("axisX" === this.parent.type)
                                ...
                                v = null,
                                w = 0; w < this.parent.dataSeries.length; w++)
                                    (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (g.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                                        value: x.dataPoint.x
                            ...
                            "dateTime" === this.parent.valueType ? g.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                    ...
                    if (E) {
                        ...
                        "dateTime" === this.parent.valueType ? g.text = this.labelFormatter ? this.labelFormatter({
                            ...
                            crosshair: this.options,
                            value: x.dataPoint.x
                        }) : s(this.options.label) ? Aa(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (g.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.x
                        }) : s(this.options.label) ? fa(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type || "error" === r[0].dataSeries.type || "rangeSplineArea" === r[0].dataSeries.type || "candlestick" === r[0].dataSeries.type || "ohlc" === r[0].dataSeries.type || "boxAndWhisker" === r[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y[0])),
                        t = u = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                    u < v && (v = u,
                                    w = t);
                            else
                                u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)),
                                u < v && (v = u,
                                w = t);
                    else if ("stackedColumn" === r[0].dataSeries.type || "stackedArea" === r[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)),
                        t = z = u = 0; t < r.length; t++)
                            if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                                for (x = 0; x < r[t].dataPoint.y.length; x++)
                                    u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                    u < v && (v = u,
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
                        ...
                        for (t = u = 0; t < x.dataPoint.y.length; t++)
                            u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[t])),
                            u < v && (v = u,
                            b = t);
                        ...
                        "waterfall" === this.parent.dataSeries[w].type ? (l = 1 === p.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0,
                        g.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum
                        }) : s(this.options.label) ? fa(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label,
                        this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (l = 1 === p.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0,
                        g.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.y
                        }) : s(this.options.label) ? fa(x.dataPoint.y, this.valueFormatString, this.chart._cultureInfo) : this.label,
                ...
                r = null;
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 && (g.y = this.chart.bounds.y1 + g.fontSize / 2),
                    "bottom" === this.parent._position && g.y + g.height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2),
                    b >= this.parent.convertValueToPixel(this.parent.viewportMinimum) && e <= this.parent.convertValueToPixel(this.parent.viewportMaximum) && (0 < q && (p.moveTo(b, f),
                    p.lineTo(e, k),
                    p.stroke(),
                    this._hidden = !1),
                    p.restore(),
                ...
                if ("left" === this.parent._position || "right" === this.parent._position)
                    "left" === this.parent._position && g.x < this.chart.bounds.x1 && (g.x = this.chart.bounds.x1),
                    "right" === this.parent._position && g.x + g.measureText().width > this.chart.bounds.x2 && (g.x = this.chart.bounds.x2 - g.measureText().width),
                    k >= this.parent.convertValueToPixel(this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.viewportMinimum) && (0 < q && (p.moveTo(b, f),
                    p.lineTo(e, k),
                    p.stroke(),
                    this._hidden = !1),
                    p.restore(),
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (E) {
                            ...
                            }) : s(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (g.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(d)
                    ...
                    g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize / 2 + 2 : g.y + g.measureText().height - g.fontSize / 2 > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.measureText().height + g.fontSize / 2),
                    "left" === this.parent._position ? g.x = this.parent.lineCoordinates.x2 - g.measureText().width : "right" === this.parent._position && (g.x = this.parent.lineCoordinates.x2);
                "left" === this.parent._position && g.x < this.chart.bounds.x1 ? g.x = this.chart.bounds.x1 : "right" === this.parent._position && g.x + g.measureText().width > this.chart.bounds.x2 ? g.x = this.chart.bounds.x2 - g.measureText().width : "top" === this.parent._position && g.y - g.fontSize / 2 < this.chart.bounds.y1 ? g.y = this.chart.bounds.y1 + g.fontSize / 2 : "bottom" === this.parent._position && g.y + g.height > this.chart.bounds.y2 && (g.y = this.chart.bounds.y2 - g.height + g.fontSize / 2 + 2);
                0 < q && (p.moveTo(b, f),
                p.lineTo(e, k),
                p.stroke(),
                this._hidden = !1);
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var l = 0; l < this.chart.axisX.length; l++) {
                                for (var k = this.chart.axisX[l].convertPixelToValue({
                                    y: d
                                }), g = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++)
                                    (g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX[l].dataSeries[b],
                                    null !== g.dataPoint.y && m.push(g));
                                g = null
                            }
                        if (this.chart.axisX2)
                            for (l = 0; l < this.chart.axisX2.length; l++) {
                                ...
                                for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)
                                    (g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX2[l].dataSeries[b],
                                    null !== g.dataPoint.y && m.push(g));
                                g = null
                            }
                    } else {
                        ...
                        if (this.chart.axisX)
                            for (l = 0; l < this.chart.axisX.length; l++)
                                ...
                                g = null,
                                b = 0; b < this.chart.axisX[l].dataSeries.length; b++)
                                    (g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX[l].dataSeries[b],
                                    null !== g.dataPoint.y && m.push(g));
                        if (this.chart.axisX2)
                            for (l = 0; l < this.chart.axisX2.length; l++)
                                ...
                                g = null,
                                b = 0; b < this.chart.axisX2[l].dataSeries.length; b++)
                                    (g = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX2[l].dataSeries[b],
                                    null !== g.dataPoint.y && m.push(g))
                    }
                    if (0 === m.length)
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (0 <= this.currentDataPointIndex)
                            ...
                            g.distance = Math.abs(b.x - k),
                            "waterfall" === e.type && (g.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue,
                            g.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
                        ...
                        if (!s(g) && !s(g.dataPoint) && !s(g.dataPoint.y))
                            if (g.dataSeries.axisY)
                                if (0 < g.dataPoint.y.length) {
                                    for (b = c = 0; b < g.dataPoint.y.length; b++)
                                        g.dataPoint.y[b] < g.dataSeries.axisY.viewportMinimum ? c-- : g.dataPoint.y[b] > g.dataSeries.axisY.viewportMaximum && c++;
                                    c < g.dataPoint.y.length && c > -g.dataPoint.y.length && f.push(g)
                                } else
                                    "column" === e.type || "bar" === e.type ? 0 > g.dataPoint.y ? 0 > g.dataSeries.axisY.viewportMinimum && g.dataSeries.axisY.viewportMaximum >= g.dataPoint.y && f.push(g) : g.dataSeries.axisY.viewportMinimum <= g.dataPoint.y && 0 <= g.dataSeries.axisY.viewportMaximum && f.push(g) : "bubble" === e.type ? (c = this.chart._eventManager.objectMap[e.dataPointIds[g.index]].size / 2,
                                    g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum - c && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum + c && f.push(g)) : "waterfall" === e.type ? (c = 0,
                                    g.cumulativeSumYStartValue < g.dataSeries.axisY.viewportMinimum ? c-- : g.cumulativeSumYStartValue > g.dataSeries.axisY.viewportMaximum && c++,
                                    g.cumulativeSum < g.dataSeries.axisY.viewportMinimum ? c-- : g.cumulativeSum > g.dataSeries.axisY.viewportMaximum && c++,
                                    2 > c && -2 < c && f.push(g)) : (0 <= g.dataSeries.type.indexOf("100") || "stackedColumn" === e.type || "stackedBar" === e.type || g.dataPoint.y >= g.dataSeries.axisY.viewportMinimum && g.dataPoint.y <= g.dataSeries.axisY.viewportMaximum) && f.push(g);
                            else
                                f.push(g)
                    }
                }
                if (0 < f.length) {
                    ...
                    if (this.enabled) {
                        ...
                        if (null !== r) {
                            ...
                            c = !1;
                            "none" === this.container.style.display && (c = !0,
                            ...
                            !this.animationEnabled || c ? this.disableAnimation() : (this.enableAnimation(),
        ...
        $.prototype.highlightObjects = function(a) {
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                    ...
                    X.drawMarkers([f]),
                    "undefined" !== typeof e.y2 && (f = b.getMarkerProperties(k, e.x1, e.y2, this.chart.overlaidCanvasCtx),
                    f.size = Math.max(1.5 * f.size << 0, 10),
                    f.borderColor = f.borderColor || "#FFFFFF",
                    f.borderThickness = f.borderThickness || Math.ceil(0.1 * f.size),
                    X.drawMarkers([f]))) : "bubble" === b.type ? (f = b.getMarkerProperties(k, e.x1, e.y1, this.chart.overlaidCanvasCtx),
                    f.size = e.size,
                    f.color = "white",
                    f.borderColor = "white",
                    d.globalAlpha = 0.3,
                    X.drawMarkers([f]),
                    d.globalAlpha = 1) : "column" === b.type || "stackedColumn" === b.type || "stackedColumn100" === b.type || "bar" === b.type || "rangeBar" === b.type || "stackedBar" === b.type || "stackedBar100" === b.type || "rangeColumn" === b.type || "waterfall" === b.type ? da(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3) : "pie" === b.type || "doughnut" === b.type ? Y(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius) : "funnel" === b.type || "pyramid" === b.type ? qa(d, e.funnelSection, 0.3, "white") : "candlestick" === b.type ? (d.globalAlpha = 1,
                    ...
                    d.globalAlpha = 1) : "ohlc" === b.type ? (d.globalAlpha = 1,
                    d.strokeStyle = e.color,
                    d.lineWidth = 2 * e.borderThickness,
                    b = 0 === d.lineWidth % 2 ? 0 : 0.5,
                    d.beginPath(),
                    ...
                    d.lineTo(e.x2, e.y4),
                    d.stroke(),
                    d.globalAlpha = 1) : "boxAndWhisker" === b.type ? (d.save(),
                    d.globalAlpha = 1,
                    ...
                    d.stroke()),
                    d.beginPath(),
                    da(d, e.x1 - e.borderThickness / 2, Math.max(e.y2 + e.borderThickness / 2, e.y3 + e.borderThickness / 2), e.x2 + e.borderThickness / 2, Math.min(e.y2 - e.borderThickness / 2, e.y3 - e.borderThickness / 2), "transparent", e.borderThickness, e.color, !1, !1, !1, !1),
                    d.globalAlpha = 1,
                    ...
                    d.stroke()),
                    d.restore(),
                    d.globalAlpha = 1) : "error" === b.type && w(d, e.x1, e.y1, e.x2, e.y2, "white", e.whiskerProperties, e.stemProperties, e.isXYSwapped, 0.3))
                }
            }
            d.restore();
            d.globalAlpha = 1;
        ...
        $.prototype.getToolTipInnerHTML = function(a) {
            ...
            if (k && (this.content && "function" === typeof this.content || this.contentFormatter))
                ...
                for (var s = null, g = "", l = 0; l < a.length; l++)
                    c = a[l].dataSeries,
                    b = a[l].dataPoint,
                    e = a[l].index,
                    f = "",
                    0 === l && (k && !this.content) && (this.chart.axisX && 0 < this.chart.axisX.length ? g += "undefined" !== typeof this.chart.axisX[0].labels[b.x] ? this.chart.axisX[0].labels[b.x] : "{x}" : this.chart.axisX2 && 0 < this.chart.axisX2.length && (g += "undefined" !== typeof this.chart.axisX2[0].labels[b.x] ? this.chart.axisX2[0].labels[b.x] : "{x}"),
                    g += "</br>",
                    g = this.chart.replaceKeywordsWithValue(g, b, c, e)),
                    ...
                    null === d && (d = ""),
                    !0 === this.reversed ? (d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d,
                    l < a.length - 1 && (d = "</br>" + d)) : (d += this.chart.replaceKeywordsWithValue(f, b, c, e),
                    l < a.length - 1 && (d += "</br>")));
                null !== d && (d = g + d)
            } else {
                c = a[0].dataSeries;
        ...
        $.prototype.showAtX = function(a, d) {
            ...
            if (this.shared)
                for (var k = 0; k < this.chart.data.length; k++)
                    c = this.chart.data[k],
                    (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
                    f.push(b));
            else
                c = this.chart.data[d],
                (b = c.getDataPointAtX(a, !1)) && (b.dataPoint && !s(b.dataPoint.y) && c.visible) && (b.dataSeries = c,
            ...
            if ("mousemove" === a.type || "click" === a.type) {
                ...
                if ((b = this.chart.getObjectAtXY(c.x, c.y, !1)) && "undefined" !== typeof this.objectMap[b])
                    ...
                    "dataPoint" === b.objectType) {
                        ...
                        "legendItem" === b.objectType && (e = this.chart.data[b.dataSeriesIndex],
                ...
                for (c = 0; c < d.length; c++) {
                    ...
                    e || (this.fireEvent(d[c], "mouseover", a),
        ...
        ea.prototype.fireEvent = function(a, d, c) {
            if (a && d) {
                ...
                "mouseout" !== d ? f.cursor && f.cursor !== c.target.style.cursor && (c.target.style.cursor = f.cursor) : (c.target.style.cursor = this.chart._defaultCursor,
        ...
        ka.prototype.animate = function(a, d, c, b, e) {
            ...
            for (a = []; 0 < this.animations.length; )
                ...
                c = (new Date).getTime(),
                b = 0,
                d.startTime <= c && (b = e(Math.min(c - d.startTime, d.duration), 0, 1, d.duration),
                b = Math.min(b, 1),
                isNaN(b) || !isFinite(b)) && (b = 1),
                1 > b && a.push(d),
          ...
          , X = {
            drawMarker: function(a, d, c, b, e, f, k, l) {
                if (c) {
                    ...
                    "circle" === b ? (c.moveTo(a, d),
                    c.beginPath(),
                    c.arc(a, d, e / 2, 0, 2 * Math.PI, !1),
                    f && c.fill(),
                    l && (k ? c.stroke() : (s = c.globalAlpha,
                    c.globalAlpha = 0.15,
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = s))) : "square" === b ? (c.beginPath(),
                    ...
                    c.strokeStyle = "black",
                    c.stroke(),
                    c.globalAlpha = s))) : "triangle" === b ? (c.beginPath(),
                    ...
                    c.stroke(),
                    c.globalAlpha = s)),
                    c.beginPath()) : "cross" === b && (c.strokeStyle = f,
                    c.lineWidth = e / 4,
                    c.beginPath(),
                    c.moveTo(a - e / 2, d - e / 2),
                    c.lineTo(a + e / 2, d + e / 2),
